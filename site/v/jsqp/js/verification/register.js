(function(){
	'use strict';
	var API_findCheckUser = vge.jsqp + '/DBTJSQPInterface/checkUser/findCheckUser';
	var API_modifyCheckUser = vge.jsqp + '/DBTJSQPInterface/checkUser/modifyCheckUser';
	var API_getCaptcha = vge.jsqp + '/DBTJSQPInterface/user/getCaptcha';
