...
　　　　	jpimg.src = "/v/zzqpNew/img/zj/jp"+x+".png?v=1";
		$('#jplb').append(jpimg);
		counts++;
	}
	
	function zj(x){
		$('#cj .gz2 img').attr('src','img/guandao2/gz2_'+x+'.png');
		//$('#zj .jp1_1').attr('src','img/guandao2/gz2_'+x+'.png');
		$('#zj .jp1_2').attr('src','img/guandao2/zj1_'+x+'.png');
