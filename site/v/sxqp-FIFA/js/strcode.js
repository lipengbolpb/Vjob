(function () {
    $(document).ready(function () {
        var CODE_URL = vge.sxqp + '/DBTSXQPInterface/user/getCaptcha';
        var INIT_URL = vge.sxqp + '/DBTSXQPInterface/sweep/getFailCount';
        var SEND_URL = vge.sxqp + '/DBTSXQPInterface/sweep/serialCode';
        var APPID = vge.sxqpappid;
        var PROJECT = 'sxqp-FIFA';
        var PHONENUM = '15311695989';
