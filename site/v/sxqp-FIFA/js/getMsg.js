(function () {
	'use strict';
    var CHECKCODE_PORT = vge.sxqp + '/DBTSXQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.sxqp + '/DBTSXQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.sxqp + '/DBTSXQPInterface/sweep/sweepQrcode';
