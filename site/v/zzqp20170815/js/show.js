...
(function () {
    ...
    vge.callJApi(javai, req, function (jo) {
        if (jo.result.code == '0') {
            ...
            if(x==1){
                $('.card').css({'left':'.4rem','top':'2.2rem'})
            }else if(x==2){
                $('.card').css({'left':'.1rem','top':'2.1rem','width':'4.19rem'})
            }else if(x==3){
                $('.card').css({'left':'.15rem','top':'2.1rem','width':'4.09rem'})
            }else if(x==4){
                $('.card').css({'left':'.16rem','top':'2.1rem','width':'4.15rem'})
            }else if(x==5){
                $('.card').css({'left':'.1rem','top':'2.1rem','width':'4.24rem'})
            }else if(x==6){
                $('.card').css({'left':'.2rem','top':'2.1rem','width':'4.03rem'})
            }
        } else {//code!='0'
    ...
    var shareimg = 'http://' + vge.zzqp_host + '/v/zzqp20170815/img/bg/beer5.png';
