...
(function () {
                            ...
                            for (var t = 0; t < Vwlq.length; t++) {
                                if (Vwlq[t].getAttribute('useStatus') == '0') {
                                    ...
                                    Vwlq[t].addEventListener('click', function () {
                                        //hmt.push(['_trackEvent', 'click', '领取奖品', '我的']);
                                    ...
                                    if (Vwlq[t].getAttribute('prizeType') == '3') {
                                        ...
                                        Vwlq[t].addEventListener('click', function () {
                                            location.href = 'http://vd.vjifen.com/v/zzqp20170815/ticket.html?a=1&ticketCode=' + this.getAttribute('ticketCode') + '&datedTime=2017-05-11';
                                        }, false);
                                    }
                                }
    ...
    function createImg(x) {
        ...
        jpimg.src = "/v/zzqp20170815/img/zj/jp" + x + ".png";
        $('#jplb').append(jpimg);
        counts++;
    }
    ...
    //游轮 电影票 猜拳 奥古特 红包
    function zj(x) {
        $('#zj .jp1_2').attr('src', '/v/zzqp20170815/img/guandao2/zj1_' + x + '.png');
        if (x == 3) {
    ...
    $('.cq').on('click', function () {
        ...
        if (sessionStorage.cq == '1') {//猜拳胜利
            ...
            location.href = '/v/zzqp20170815/g3/index.html';
        }
    });
