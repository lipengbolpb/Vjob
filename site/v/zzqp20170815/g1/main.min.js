...
var Game = function(t) {
    ...
    h.onInit = function() {
        ...
        var e = new egret.Bitmap(RES.getRes("home"));
        e.height = this.stage.stageHeight,
        this._home.addChild(e);
        var i = new egret.Bitmap(RES.getRes("btn"));
        i.x = 75,
        i.y = this.stage.stageHeight - i.height - 70,
        i.touchEnabled = !0,
        ...
        s.x = this.stage.stageWidth - i.width - 75,
        s.y = this.stage.stageHeight - s.height - 70,
        s.touchEnabled = !0,
        ...
        var h = new egret.Bitmap(RES.getRes("bg"));
        h.height = this.stage.stageHeight,
        this.addChild(h),
        this._pspr = new egret.Sprite,
        this._pspr.x = 82,
        this._pspr.y = 69,
        this.addChild(this._pspr),
        this._mask = new egret.Bitmap(RES.getRes("mask")),
        ...
        var n = new egret.Bitmap(RES.getRes("bgitem"));
        n.height = this.stage.stageHeight,
        this.addChild(n),
        this._restart = new egret.Bitmap(RES.getRes("restart")),
        this._restart.name = "restart",
        this._restart.touchEnabled = !0,
        this._restart.addEventListener(egret.TouchEvent.TOUCH_TAP, this.reStart, this),
        //this._restart.x = this.stage.stageWidth - this._restart.width - 75,
		this._restart.x = 75,
        this._restart.y = h.height - 245,
        this.addChild(this._restart),
        this._back = new egret.Bitmap(RES.getRes("back")),
        this._back.name = "back",
        this._back.touchEnabled = !0,
        this._back.addEventListener(egret.TouchEvent.TOUCH_TAP,
        function() {
            GameSound.sound_hit2.play(0, 1),
            window.backHome()
        },
        this),
        this._back.x = this.stage.stageWidth - this._back.width - 75,
        //this._back.y = this._restart.y + this._restart.height + 20,
		this._back.y = h.height - 245,
        this.addChild(this._back),
        this._p1 = new egret.Bitmap(RES.getRes("p1")),
        this._p1.x = 30,
        this._p1.y = 40,
        this._p1.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouch, this),
        this._p2 = new egret.Bitmap(RES.getRes("p2")),
        this._p2.x = this._p1.x + this._p1.width + 22,
        this._p2.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouch, this),
        this._p3 = new egret.Bitmap(RES.getRes("p3")),
        this._p3.y = this._p1.y + this._p1.height + 20,
        this._p3.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouch, this),
        this._p4 = new egret.Bitmap(RES.getRes("p4")),
        this._p4.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouch, this),
        this._parr = [this._p1, this._p2, this._p3, this._p4],
        this._iarr = [new egret.Point(44, 48), new egret.Point(this._p1.x + this._p1.width + 22, 48), new egret.Point(44, this._p1.y + this._p1.height + 20), new egret.Point(this._p2.x, this._p3.y)],
        this._tips = new egret.Bitmap(RES.getRes("tips")),
        this._tips.height = this.stage.stageHeight,
        this._tips.name = "tips",
        this._tips.visible = !1,
    ...
    h.reset = function() {
        this._mask.visible && (this._mask.visible = !1),
        this._sp.visible = !1,
        this._parr = this.rSort(this._parr),
        this._pspr.removeChildren();
        for (var t = 0,
        e = this._parr.length; e > t; t++) this._parr[t].x = 486 - this._parr[t].width >> 1,
        this._parr[t].y = 670 - this._parr[t].height >> 1,
        this._pspr.addChild(this._parr[t]);
        this.pMove(0)
    },
    h.reStart = function(t) {
        this._sp.visible && (GameSound.sound_hit2.play(0, 1), this.reset())
    },
    h.onTouch = function(t) {
        GameSound.sound_hit1.play(0, 1),
        this._tips.visible && (this._tips.visible = !1),
        this.adTouch(!1);
        for (var e = Math.floor(15 * Math.random() + 1); this._random == e;) e = Math.floor(15 * Math.random() + 1);
        this._random = e,
        this._mask.visible = !0,
        this._sp.texture = RES.getRes("s" + e),
        this._sp.visible = !0
    },
    h.rSort = function(t) {
        for (var e = [], i = 0, s = 0, h = t.length; h > s; s++) i = Math.floor(Math.random() * t.length),
        e.push(t[i]),
        t.splice(i, 1);
        return e
    },
    h.pMove = function(t) {
        var e = this;
        return t >= this._parr.length ? void("tips" == this._tips.name ? (this._tips.name = "", this._tips.visible = !0, setTimeout(function() {
            e._tips.visible = !1,
            e.adTouch(!0)
        },
        2e3)) : this.adTouch(!0)) : void egret.Tween.get(this._parr[t]).to({
            x: this._iarr[t].x,
            y: this._iarr[t].y
        },
        250).call(this.pMove, this, [++t])
    },
    h.adTouch = function(t) {
        for (var e = 0,
        i = this._parr.length; i > e; e++) this._parr[e].touchEnabled = t
    },
    e
