(function(){
	...
	var tx = 0,
		txflag = sessionStorage.txflag==undefined?false:true;
				...
				if (jo.result.code==='0') {
		            if( jo.result.businessCode==='0') {
		            	if(currentpage==1){
			            	...
			            	if(jo.reply.objList.length>0 && jo.reply.objList[0].extractStatus=='0'){
								tx = jo.reply.objList[0].earnMoney;
							}
			            	if(txflag){
		            			dom_tx.innerHTML = tx;
		            		}else{
