(function () {
    ...
    function sub_message() { // 提交信息
        var javai = vge.ymqp + '/DBTXYMQPInterface/user/updateUserInfoMobile';
        var req = {
            "openid": openid,
            "phonenum": $('#tel').val(),
            "captcha": $('#yz_code').val()
        ...
        if (jo.result.code == '0') {
            switch (jo.result.businessCode) {
                ...
                case '7':              // 大奖
                    ...
                    location.replace('http://' + location.host + '/v/ymqp20170918/prize.html?bizcode=' + jo.result.businessCode);
                    break;
                case '15':  //他人重复扫大奖
                    sessionStorage.grandPrizeType = jo.reply.grandPrizeType === undefined ? '' : jo.reply.grandPrizeType;
                ...
                default:
                    ...
                    location.replace('http://' + location.host + '/v/ymqp20170918/fail.html?bizcode=' + jo.result.businessCode);
            }
