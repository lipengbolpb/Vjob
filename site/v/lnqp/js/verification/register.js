(function(){
	'use strict';
	var API_findCheckUser = vge.lnqp + '/DBTLNQPInterface/checkUser/findCheckUser';
	var API_modifyCheckUser = vge.lnqp + '/DBTLNQPInterface/checkUser/modifyCheckUser';
	var API_getCaptcha = vge.lnqp + '/DBTLNQPInterface/user/getCaptcha';
