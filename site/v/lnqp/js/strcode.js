(function () {
    $(document).ready(function () {
        var CODE_URL = vge.lnqp + '/DBTLNQPInterface/user/getCaptcha';
        var INIT_URL = vge.lnqp + '/DBTLNQPInterface/sweep/getFailCount';
        var SEND_URL = vge.lnqp + '/DBTLNQPInterface/sweep/serialCode';
