...
var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI1NTQ5MzA2Mw==&mid=100000399&idx=1&sn=117877b7321c99dd56ca7fa2c1215e0b&chksm=6a3454275d43dd315f8eddd8c82925bd219d875ce671504176ff98f330b37f1d7600388b0193#rd';
var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI1NTQ5MzA2Mw==&mid=100000401&idx=1&sn=56c6e6ffa8e1be5fbb729d7862597876&chksm=6a3454395d43dd2f0c6c34bd71387f2689b8ff93834f7a6e7239a98115e0c5c5b3cacdfc94ae#rd';
...
$(document).ready(function () {
    ...
    function sub_message() { // 提交注册信息
        ...
        vge.callJApi(javai, req, function (jo) {
            if (jo.result.code === '0') {
                if (jo.result.businessCode === '0') {
                    title_tip('提 示', '您的中奖信息我们已经收到，请拨打<br> 0571-28227057联系我们进行身份核实', '我知道了');
                    $('.alert').html('温馨提示：您的信息已提交成功，请耐心等待主办方与您联系');
                    $('#btn').val('提交成功');
                    $('#btn').attr('disabled', 'true');
