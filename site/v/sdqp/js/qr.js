        ...
        if (jo.result.code == '0') {
            ...
            if (jo.reply) {
                ...
                if (jo.reply.activityVersion === "1") {   //奥古特
                    project = 'sdqp-agt';
                } else if (jo.reply.activityVersion === "2" || jo.reply.activityVersion === "3" || jo.reply.activityVersion === "4" || jo.reply.activityVersion === "5" || jo.reply.activityVersion === "7") { 
                    //经典8度
                    //世界杯版 //7-经典 8-1903【已释放】==>皮尔森 
                    project = 'sdqp-common2.0';
                } else if (jo.reply.activityVersion === "6") { //经典新年版
                    project = 'sdqp20180130';
                } else if(jo.reply.activityVersion === "8"){
                    project = 'sdqp-prs';
                } else if(jo.reply.activityVersion === "9"){ //崂山版
