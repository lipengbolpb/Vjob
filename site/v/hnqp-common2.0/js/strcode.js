                    ...
                    switch (jo.result.businessCode) {
                        ...
                        case '7': // 大奖
                            ...
                            if (jo.reply.grandPrizeType == 'p' || jo.reply.grandPrizeType == 'P') {
                                ...
                                location.replace('http://' + location.host + '/v/' + PROJECT + '/prize.html?bizcode=' + jo.result.businessCode);
                            }  else if (jo.reply.grandPrizeType == 'u' || jo.reply.grandPrizeType == 'U') {//冰墩墩
                                location.replace('http://' + location.host + '/v/' + PROJECT + '/prize.html?bizcode=' + jo.result.businessCode);
                            }  else if (jo.reply.grandPrizeType == 'v' || jo.reply.grandPrizeType == 'V') {//p30
                                location.replace('http://' + location.host + '/v/' + PROJECT + '/prize.html?bizcode=' + jo.result.businessCode);
                        ...
                        case '15': //他人重复扫大奖
                           ...
                           if(jo.reply.grandPrizeType == '1' || jo.reply.grandPrizeType == '2'){
                               ...
                               location.replace('http://' + location.host + '/v/' + PROJECT + '/prize.html?bizcode=' + jo.result.businessCode);
                           }else if(jo.reply.grandPrizeType == 'u' || jo.reply.grandPrizeType == 'U'){
                               location.replace('http://' + location.host + '/v/' + PROJECT + '/prize.html?bizcode=' + jo.result.businessCode);
                           }else if(jo.reply.grandPrizeType == 'V' || jo.reply.grandPrizeType == 'v'){
                               location.replace('http://' + location.host + '/v/' + PROJECT + '/prize.html?bizcode=' + jo.result.businessCode);
                           }
                            break;
                        case '-1':
