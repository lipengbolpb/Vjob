...
var v_port = {
    ...
    post_port: 'https://hapi.vjifen.com' //后台测试接口
}
/**
 * 获取用户基本信息
...
function iniUserInfo() {
    ...
    var nickname = sessionStorage.nickname == 'undefined' ? '未知用户' : decodeURIComponent(sessionStorage.nickname);
...
function connectQ(p) {
    //************* */
    var url = v_port.post_port + '/DBTHNQPInterface/vpointsGame/gameTrans';
    var data = {
