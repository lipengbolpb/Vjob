...
var info = {
    URL_POST: vge.zzqpWeChat + '/DBTHNQPInterface/user/integralLottery',
    EXCHANGE_POST: vge.zzqpWeChat + '/DBTHNQPInterface/myInfo/exchangePrize',
    openid: openid
}
console.log(info)
var reg1 = /^1[0-9]{10}$/,
...
window.onload = function () {
                        ...
                        if (res.result.businessCode == '0') {
                            ...
                            switch (res.reply.prizeType) {
                                ...
                                case '17': //
                                    ...
                                    imgEnd = 0;
                                    $('.line1').html('恭喜你抽中<span id="prize">冬奥环球之旅1人次</span>');
                                    $('.line2').html('请到"中奖记录"里面查看并领奖');
                                    break;
                                case '0': //现金红包
                            ...
                            function roll() {
                                ...
                                if (luck.times > luck.cycle + 10 && luck.prize == luck.index) {
                                    ...
                                    luck.prize = -1;
                                    luck.times = 0;
                                    $('.result').attr('src', 'https://' + location.host + '/v/zzqpWeChat/game1/img/_0' + imgEnd + '.png?v=1');
                                    setTimeout(function () {
                                        $('.alert').fadeIn();
                                    }, 500);
    ...
    setInterval(function () {
        if (flag) {
            flag = false;
            $('.slogan').attr('src', 'https://' + location.host + '/v/zzqpWeChat/game1/img/slogan-2.png');
        } else {
            flag = true;
            $('.slogan').attr('src', 'https://' + location.host + '/v/zzqpWeChat/game1/img/slogan-1.png');
        }
    }, 500);
};