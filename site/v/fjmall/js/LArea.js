    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                area_city.addEventListener('touchstart', gearTouchStart,false);
                area_county.addEventListener('touchstart', gearTouchStart,false);
                area_province.addEventListener('touchmove', gearTouchMove,false);
                area_city.addEventListener('touchmove', gearTouchMove,false);
                area_county.addEventListener('touchmove', gearTouchMove,false);
                area_province.addEventListener('touchend', gearTouchEnd,false);
                area_city.addEventListener('touchend', gearTouchEnd,false);
                area_county.addEventListener('touchend', gearTouchEnd,false);
            }
            //初始化插件默认值
            ...
            function gearTouchStart(e) {
                ...
                gearTouchMove(e);//移至此处并在TouchMove事件开始时 打印日志 否则报错？？？
            }
            //手指移动
            function gearTouchMove(e) {
                e.preventDefault();
                console.log('gearTouchMove',e);//此处TouchMove事件开始时 打印日志 否则报错？？？
                var target = e.target;
                while (true) {
                    if (!target.classList.contains("gear")) {
                        target = target.parentElement;
        ...
        finish: function(e) {
			...
			console.log(_self.trigger.value,this.valueTo.value)
            _self.close(e);
        },
        close: function(e) {
            e.preventDefault();
