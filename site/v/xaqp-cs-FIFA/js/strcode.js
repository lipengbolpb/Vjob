(function () {
    $(document).ready(function () {
        var CODE_URL = vge.xaqp + '/DBTXIANQPInterface/user/getCaptcha';
        var INIT_URL = vge.xaqp + '/DBTXIANQPInterface/sweep/getFailCount';
        var SEND_URL = vge.xaqp + '/DBTXIANQPInterface/sweep/serialCode';
        var APPID = vge.xaqpappid;
        var PROJECT = 'xaqp-cs-FIFA';
        var PHONENUM = '029-86702713';
