    ...
    function cb(jo) {
		if(jo.result.code == '0'){
	        ...
	        case '0':               // 普通奖
				...
				location.replace('http://' + location.host + '/ynqp/txo/getcash?bizcode='+jo.result.businessCode);
	            break;
	        case '11':              // 自己重复扫，普通奖
				sessionStorage.totalAccountMoney = jo.reply.totalAccountMoney;
				sessionStorage.currentMoney = jo.reply.currentMoney;
				sessionStorage.codeContentUrl = jo.reply.codeContentUrl;
				location.replace('http://' + location.host + '/ynqp/txo/repcash?bizcode='+jo.result.businessCode);
	            break;
	        default:
	        	if(jo.reply){
	        		sessionStorage.batchName = jo.reply.batchName===undefined?'':jo.reply.batchName;
	        	}	
				location.replace('http://' + location.host + '/v/ynqp/fail.html?bizcode='+jo.result.businessCode);
	        }	
