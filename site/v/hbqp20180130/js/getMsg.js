(function () {
	'use strict';
    let CHECKCODE_PORT = vge.hbqp + '/DBTHBQPInterface/user/getCaptcha';
    let SUBMESSAGE_PORT = vge.hbqp + '/DBTHBQPInterface/user/updateUserInfoMobile';
    let SWEEP_PORT = vge.hbqp + '/DBTHBQPInterface/sweep/sweepQrcode';
    let PROJECT = 'hbqp20180130';
    let PHONE_NUM = '0311-66600300';
    let NAME = '青岛啤酒乐享河北';
