$(document).ready(function () {
    let CODE_URL = vge.hbqp + '/DBTHBQPInterface/user/getCaptcha';
    let INIT_URL = vge.hbqp + '/DBTHBQPInterface/sweep/getFailCount';
    let SEND_URL = vge.hbqp + '/DBTHBQPInterface/sweep/serialCode';
    let APPID = vge.hbqpappid;
    let PROJECT = 'hbqp20180130';
