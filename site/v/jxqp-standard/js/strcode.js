(function () {
    $(document).ready(function () {
        ...
        var PROJECT = 'jxqp-standard';  //jxqp-common3.0
        var PHONE_NUM = '18519813990';
        ...
        function only_strcode() {
            ...
            document.getElementById('str_code').addEventListener('input', function () {
                // console.log(reg1.test($('#str_code').val()))
                ...
                if (jo.result.code === '0') {
                    if (jo.reply) {
                        ...
                        if (jo.reply.activityVersion == '1') {
                            PROJECT = 'jxqp-standard';  //jxqp-common2.0
                    ...
                    switch (jo.result.businessCode) {
                        ...
                        case '6': // 6 - 积分码异常(通常为服务器报错)
                            ...
                            $('#btn').attr('disabled', 'disabled');
                            break;
                        case '7': // 大奖    // P为冬奥环球之旅 Q为青岛之旅  R等奖-冬奥冰雪冬令营 S等奖-青岛啤酒精酿有一套礼盒
                            ...
                            if (jo.reply.grandPrizeType == 'p' || jo.reply.grandPrizeType == 'P'|| jo.reply.grandPrizeType == 'q' || jo.reply.grandPrizeType == 'Q'|| jo.reply.grandPrizeType == 'r' || jo.reply.grandPrizeType == 'R'|| jo.reply.grandPrizeType == 's' || jo.reply.grandPrizeType == 'S') {
