(function() {
	...
	window.onload = function() {
		...
		var PROJECT = 'jxqp-standard';
		var RULE_URL =
			'https://mp.weixin.qq.com/s?__biz=MzI3OTUzNzEzMQ==&mid=100002278&idx=1&sn=660a96d74a83b26d6adc875e2c0122e3&chksm=6b477d625c30f474ae6b19a2b2c4a05f0b9d085d852bf6c1ecee8fe85522967994029721f4f9#rd';
		// var EXPLAIN_URL = '';
		...
		$('.open').on('touchstart', function() {
			...
			$('.cash').fadeIn(function() {
				setTimeout(() => {
					...
					// 	$('.activImg').attr('src','/v/jxqp-standard/img/190731ad.jpg');     //活动时间8月
