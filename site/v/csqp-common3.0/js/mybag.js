(function () {
    ...
    var GiftsList_PORT = vge.csqp + '/DBTHuNanQPInterface/gifts/queryPrizeList'; //大奖列表
	var API_getCaptcha = vge.csqp + '/DBTHuNanQPInterface/user/getCaptcha'; //获取验证码接口
    ...
    dom_qrbtn.addEventListener('click', function(ev) {
        ...
        canvas.width = size;
        canvas.height = size;
        qrcode.makeCode('HTTP://VJ1.TV/N/'+$('#qrcode').val());
