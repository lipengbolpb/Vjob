(function () {
    $(document).ready(function () {
        ...
        var PROJECT = 'csqp-common3.0';
        var PHONE_NUM = '17607319500';
            ...
            vge.callJApi(javai, req, function (jo) {
                ...
                if (jo.result.code === '0') {
                    if (jo.reply) {
                        ...
                        // 中秋节红包语
                        sessionStorage.scanLadderFlag = jo.reply.scanLadderFlag === undefined ? '' : jo.reply.scanLadderFlag;
                        sessionStorage.spuDayScanNum = jo.reply.spuDayScanNum === undefined ? '' : jo.reply.spuDayScanNum;
