(function () {
	'use strict';
    var CHECKCODE_PORT = vge.jlqp + '/DBTJLQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.jlqp + '/DBTJLQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.jlqp + '/DBTJLQPInterface/sweep/sweepQrcode';
    var PROJECT = 'jlqp-laoshanShouti';
    var PHONE_NUM = '15652287347';
    var NAME = 'TSINGTAO青岛啤酒乐享吉林';
        ...
        if (jo.result.code == '0') {
            switch (jo.result.businessCode) {
                ...
                case '7': // 大奖
                    ...
                    if (jo.reply.grandPrizeType == 'p' || jo.reply.grandPrizeType == 'P' || jo.reply.grandPrizeType == '1') {
