(function () {
    $(document).ready(function () {
        var CODE_URL = vge.ymqp + '/DBTXYMQPInterface/user/getCaptcha';
        var INIT_URL = vge.ymqp + '/DBTXYMQPInterface/sweep/getFailCount';
        var SEND_URL = vge.ymqp + '/DBTXYMQPInterface/sweep/serialCode';
        var APPID = vge.ymqpappid;
        var PROJECT = 'ymqp-FIFA';
                ...
                success: function (jo, status, xhr) {
                    ...
                    if (jo.result.code === '0') {
                        if (jo.reply) {
                            ...
                            if (jo.reply.activityVersion == '1') { //烤串版
                                PROJECT = 'ymqp';
                            } else if (jo.reply.activityVersion == '2') { //新年版
                                PROJECT = 'ymqp20180130';
                        ...
                        switch (jo.result.businessCode) {
                            ...
                            case '4': // 4 - 活动未开始
                                $('.border').css('visibility', 'visible');
                                $('.title').html('您的幸运正在累积中');
                                $('.content').html('再扫一瓶试试看');
