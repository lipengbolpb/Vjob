(function () {
	'use strict';
    var CHECKCODE_PORT = vge.ymqp + '/DBTXYMQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.ymqp + '/DBTXYMQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.ymqp + '/DBTXYMQPInterface/sweep/sweepQrcode';
