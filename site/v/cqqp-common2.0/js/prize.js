(function () {
    ...
    // https://mp.weixin.qq.com/s?__biz=MzA4MzMxMDgyNA==&mid=300055174&idx=1&sn=e126844a6706e9344870a57d8d4aeb75&chksm=0beebb013c9932170f857bdf943316525ed878e3702ef805f631025bb183ee0a3b28f519585e#rd
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzIxNDE4NTQ4MA==&mid=502752400&idx=1&sn=47112497705e7d28907bc8fe616ee2b4&chksm=0fa8a7f738df2ee1a07cd6ad73f4c4a7bba6eab5e4523d1c5f07443a3db97e0e1e4bcf739189#rd';
    // https://mp.weixin.qq.com/s?__biz=MzIxNDE4NTQ4MA==&mid=502752239&idx=1&sn=3dff1c4a0775767b165bdf5fdbcd0f85&chksm=0fa8a08838df299e78864a508d7d608b507ef2d7345d3f56b423b43adbdf476ddecd9b46bdcc#rd
    var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzIxNDE4NTQ4MA==&mid=502752402&idx=1&sn=4516cdc3bf74d6d5ace6ac4ac3c74a9c&chksm=0fa8a7f538df2ee379d66b75db5ee588fe38cfac1eac612702c7f3180259e3e600b6e560fdca#rd';
    ...
    $(document).ready(function () {
        //  alert('11111')
        //  alert(grandPrizeType)
        if (grandPrizeType == 'P' || grandPrizeType == 'p') {//黄金冰墩墩
            $('.prize-one').attr("src","img/prizeBdd.png");
            $('.prize-bg').attr("src","img/prizeBdd.png");
            $('.bdd').css('display','block')
        }
        if (grandPrizeType == 'Q' || grandPrizeType == 'q') {//金球
            $('.prize-one').attr("src","img/prizeBall.png");
            $('.prize-bg').attr("src","img/prizeBall.png");
            $('.goldBall').css('display','block');
            $('.goldBall').css('display','block');
        }
        init();
