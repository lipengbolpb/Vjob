(function () {
	'use strict';
    var CHECKCODE_PORT = vge.csqp + '/DBTHuNanQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.csqp + '/DBTHuNanQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.csqp + '/DBTHuNanQPInterface/sweep/sweepQrcode';
