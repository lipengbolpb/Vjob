(function () {
    ...
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI4NjE2MzQ2Mw==&mid=504504574&idx=1&sn=a32cf65109224b18a1a4e97ec05889f1&chksm=7007979647701e80aa80b4b5ff68faa22a610760bcc8150c77d50b1c27b9ffdfa18e840e3c88#rd';
    var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI4NjE2MzQ2Mw==&mid=504504576&idx=1&sn=497e2cac701df2fe8681a041e3ac5db6&chksm=7007966847701f7e04646d78fa19edf444ae9fa9c6bbe6d2c06aeb835ac3259389a63cfdd3fa#rd';
    ...
    var openid = sessionStorage.vjifenOpenid === undefined ? '' : sessionStorage.vjifenOpenid,
        ...
        prizeVcode = sessionStorage.vqr === undefined ? '' : sessionStorage.vqr, //具体码
    ...
    $(document).ready(function () {
        ...
        function sub_message() { // 提交注册信息
            ...
            vge.callJApi(javai, req, function (jo) {
                if (jo.result.code === '0') {
                    if (jo.result.businessCode === '0') {
                        title_tip('提 示', '您的中奖信息我们已经收到，请拨打<br> 0771-3806691联系我们进行身份核实', '我知道了');
                        $('.alert').html('温馨提示：您的信息已提交成功，请耐心等待主办方与您联系');
                        $('#btn').val('提交成功');
                        $('#btn').attr('disabled', 'true');
