...
function init_basic(first) { //初始化日报概况部分
    if (itemValue == 'false') {
        ...
        document.getElementById('freshName').innerHTML = '当日消费者';
    }
...
function getOne(way, index) { //tool第一行(消费者人数)
    if (way == true) { //用户趋势
        ...
        document.getElementById('tool_one').innerHTML = `消费者人数:${x}(${y})`;
    } else { //扫码趋势
        ...
        document.getElementById('tool_one').innerHTML = `开瓶扫码量:${a}(${b})`;
    }
}
...
function getTwo(way, index) {
    if (way == true) { //用户趋势
        ...
        document.getElementById('tool_two').innerHTML = `新增消费者:${x}(${y})`;
    } else { //扫码趋势
        ...
        document.getElementById('tool_two').innerHTML = `返利积分:${a}(${b})`;
    }
}
...
function getThree(way, index) {
    if (way == true) { //用户趋势
        ...
        document.getElementById('tool_three').innerHTML = `新增消费者占比:${x}(${y})`;
    } else { //扫码趋势
        ...
        document.getElementById('tool_three').innerHTML = `人均消费量:${a}(${b})`;
    }
}
