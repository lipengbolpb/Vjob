(function () {
    $(document).ready(function () {
        var CODE_URL = vge.common + '/vjifenInterfaceuser/getCaptcha';
        var INIT_URL = vge.common + '/vjifenInterfacesweep/getFailCount';
        var SEND_URL = vge.common + '/vjifenInterfacesweep/serialCode';
        var APPID = vge.jxqpappid;
        var PROJECT = 'jxqp-FIFA';
