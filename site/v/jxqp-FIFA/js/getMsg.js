(function () {
	'use strict';
    var CHECKCODE_PORT = vge.common + '/vjifenInterfaceuser/getCaptcha';
    var SUBMESSAGE_PORT = vge.common + '/vjifenInterfaceuser/updateUserInfoMobile';
    var SWEEP_PORT = vge.common + '/vjifenInterfacesweep/sweepQrcode';
