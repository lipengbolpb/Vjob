...
var PROJECT = 'xaqp-cs-common2.0';
var imgUrl = '/v/xaqp-cs-common2.0/';
var _host = vge.xaqpimg + '/DBTXIANQPPlatform';
var iconFlag = true;
...
function sign() { //混合签到功能
    var tpl_1 = '<div class="swiper">' +
        ...
        '<img src="/v/xaqp-common2.0/img/sign/hb.png" class="signHb" style="display: block;">' +
        '</div>';
