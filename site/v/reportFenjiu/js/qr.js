    ...
    if (itemValue == false) {
        var requrl = 'http://59.110.53.118:9008/DBTMainEntStats/reportDetail/getReportData.do?queryDate=' + queryDate;
    } else {
    ...
    $.ajax({
        ...
        success: function (jo) {
            ...
            window.location.replace('http://w.vjifen.com/v/reportFenjiu/index.html')
        },
        error: function () {
