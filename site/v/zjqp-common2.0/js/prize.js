(function () {
    ...
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI1NTQ5MzA2Mw==&mid=100000557&idx=1&sn=0890314562f9ea16ab805f1ca998356a&chksm=6a3455855d43dc9319236e00825a9680a496fc46b6038a39bdb9769b75b094fba708cfac19d3#rd';
    var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI1NTQ5MzA2Mw==&mid=100000559&idx=1&sn=5375c2b43f2b34e45f3a451348a7b5c5&chksm=6a3455875d43dc915163452fad65aaa380f9f6f965746e59b01c2eb4030aeee9199023c3e178#rd';
    var PHONE_NUM = '15557170859';
    ...
    var openid = sessionStorage.openid === undefined ? '' : sessionStorage.openid,
        vjifenOpenid = sessionStorage.vjifenOpenid === undefined ? '' : sessionStorage.vjifenOpenid,
    ...
    $(document).ready(function () {
        if (grandPrizeType == 'p' || grandPrizeType == 'p') {//冬奥环球之旅
            $('.prize-one').attr("src","img/prize1.png");
            $('.prize-bg').attr("src","img/prize-bg1.png");
            init();
        } else if (grandPrizeType == 'Q' || grandPrizeType == 'q') {//冬奥冰雪冬令营
            $('.prize-one').attr("src","img/prize2.png");
            $('.prize-bg').attr("src","img/prize-bg2.png?v=1");
             init();
        } else if (grandPrizeType == 'R' || grandPrizeType == 'r') {//青啤有一套
            $('.prize-one').attr("src","img/prize3.png?v=1.0");
