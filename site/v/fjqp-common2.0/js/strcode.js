(function () {
    $(document).ready(function () {
        ...
        if(new Date().getTime()>new Date(2020,1,28).getTime() && new Date().getTime()<new Date(2020,3,1).getTime() && sessionStorage.skukey=="241510936-012"){ 
            ...
            document.getElementsByClassName('slogan')[0].style.width = "86%";
        }else {
        ...
        // 时间
        console.log(new Date().getTime()>new Date(2020,1,28).getTime() && new Date().getTime()<new Date(2020,3,1).getTime())
