(function(){
    ...
    function cbk(jo) {
		var replace = '/v/zzqp/index.html?bizcode=';
       	if(jo.result.code=='0'){
//     		console.log(jo);
       		if(jo.result.versionCode){
	       		if(jo.result.versionCode=='1.17.0214'){
	       			...
	       			replace = '/v/zzqp/index.html?bizcode=';
	       		}
       		}
	        ...
	        case '11':              // 自己重复扫，普通奖
	            ...
	            break;
	        case '12':              // 可疑用户
				location.replace('http://' + location.host + '/v/zzqp/getMsg.html?bizcode=' + jo.result.businessCode);
	            break;
	        case '14':              // 指定用户
				location.replace('http://' + location.host + '/v/zzqp/getMsg.html?bizcode=' + jo.result.businessCode);
	            break;    
