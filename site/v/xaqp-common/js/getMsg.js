(function () {
    const CHECKCODE_PORT = vge.xaqp + '/DBTXIANQPInterface/user/getCaptcha';
    const SUBMESSAGE_PORT = vge.xaqp + '/DBTXIANQPInterface/user/updateUserInfoMobile';
    const SWEEP_PORT = vge.xaqp + '/DBTXIANQPInterface/sweep/sweepQrcode';
    const PROJECT = 'xaqp-common';
    const PHONE_NUM = '029-86702713';
    const NAME = '青啤汉斯陕西销售';
