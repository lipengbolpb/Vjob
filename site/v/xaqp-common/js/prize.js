(function () {
    ...
    var CHECKCODE_URL = vge.xaqp + '/DBTXIANQPInterface/user/getCaptcha';
    var SUBMESSAGE_URL = vge.xaqp + '/DBTXIANQPInterface/user/savePrize';
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI2MDk3NTY3NQ==&mid=100000005&idx=1&sn=ff807dde8555641a222053581701bb02&chksm=6a603c515d17b547ca1de282fa382c6d68afb10bf1d56f1b2538fd9e38a09445254e5916fde1#rd';
    var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI2MDk3NTY3NQ==&mid=100000007&idx=1&sn=e520a52b97c68a22f57a05955690a06c&chksm=6a603c535d17b54503be14bdccf8c5247cf2c0fce178114950116c54368ba6540f2bc2159a82#rd';

    if (sessionStorage.skukey == '241510936-003') {
        RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI2MDk3NTY3NQ==&mid=100000032&idx=1&sn=7da731df7328a895ed8c963b3c99564c&chksm=6a603c745d17b562776111422c9203418d6add0a70739ec68eda995298f2e0290964a5af1779#rd';
    }
    ...
    $(document).ready(function () {
        ...
        function sub_message() { // 提交注册信息
            ...
            vge.callJApi(javai, req, function (jo) {
                if (jo.result.code === '0') {
                    if (jo.result.businessCode === '0') {
                        title_tip('提 示', '您的中奖信息我们已经收到，请拨打<br> 029-86702713联系我们进行身份核实', '我知道了');
                        $('.alert').html('温馨提示：您的信息已提交成功，请耐心等待主办方与您联系');
                        $('#btn').val('提交成功');
                        $('#btn').attr('disabled', 'true');
