    ...
    function getMsg(jo) {
        if (jo.reply.companyInfoList) {
            for (var o = 0; o < jo.reply.companyInfoList.length; o++) {
                if(jo.reply.companyInfoList[o].companyName === '终端促销河北'){
        ...
        if (jo.reply.userInfo.nickName === undefined || jo.reply.userInfo.headImgUrl === '') {
