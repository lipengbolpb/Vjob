...
let CHECKCODE_URL = vge.hnqp + '/DBTHuaNQPInterface/user/getCaptcha';
let SUBMESSAGE_URL = vge.hnqp + '/DBTHuaNQPInterface/user/savePrize';
let RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzU4NTA3MDkzMA==&mid=100000271&idx=1&sn=5b3c0dbf25b16c57738a9d3c749ae6e0&chksm=7d9162324ae6eb248ce1549ca249fe411df98a192c7404362ba150a54bea11d01c3f2e896c11#rd';
let SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzU4NTA3MDkzMA==&mid=100000268&idx=1&sn=ff940076c885ff7cd98d59a67bd52f33&chksm=7d9162314ae6eb27e7153b1b48d5de54efbdfd8e24e0a369f6b909074f2f633c60923f5a0871#rd';

let dom_get = document.getElementsByClassName('yz')[0];

let reg1 = /^1[0-9]{10}$/, //验证手机号
...
$(document).ready(function () {
    ...
    function sub_message() { // 提交注册信息
        ...
        vge.callJApi(javai, req, function (jo) {
            if (jo.result.code === '0') {
                if (jo.result.businessCode === '0') {
                    title_tip('提 示', '您的中奖信息我们已经收到，请拨打<br> 0539-4636210联系我们进行身份核实', '我知道了');
                    $('.alert').html('温馨提示：您的信息已提交成功，请耐心等待主办方与您联系');
                    $('#btn').val('提交成功');
                    $('#btn').attr('disabled', 'true');
