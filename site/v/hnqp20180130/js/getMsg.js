(function () {
    ...
    let CHECKCODE_PORT = vge.hnqp + '/DBTHuaNQPInterface/user/getCaptcha';
    let SUBMESSAGE_PORT = vge.hnqp + '/DBTHuaNQPInterface/user/updateUserInfoMobile';
    let SWEEP_PORT = vge.hnqp + '/DBTHuaNQPInterface/sweep/sweepVerify';
