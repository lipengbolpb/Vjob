(function () {
    $(document).ready(function () {
        ...
        var PROJECT = 'gxqp-FIFA';
        var PHONENUM = '15652287347'; //活动未开始电话
                ...
                success: function (jo, status, xhr) {
                    ...
                    if (jo.result.code === '0') {
                        if (jo.reply) {
                            ...
                            if (jo.reply.activityVersion == '2') { //春节版
                                PROJECT = 'gxqp20171214';
                            } else if (jo.reply.activityVersion == '3') { //游轮版
                                // PROJECT = 'csqp20180130';
                            } else if (jo.reply.activityVersion == '4') { //经典通用版
                                PROJECT = 'gxqp-common';
                            } else if (jo.reply.activityVersion == '5') { //世界杯
                                PROJECT = 'gxqp-FIFA';
                            } else {
                                PROJECT = 'gxqp-common';
                            }
