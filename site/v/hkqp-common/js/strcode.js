$(document).ready(function () {
    const CODE_URL = vge.common + '/vjifenInterface/user/getCaptcha';
    const INIT_URL = vge.common + '/vjifenInterface/sweep/getFailCount';
    const SEND_URL = vge.common + '/vjifenInterface/sweep/serialCode';
    const APPID = vge.hkqpappid;
    const PROJECT = 'hkqp-common';
