(function() {
	$(document).ready(function() {
		var CODE_URL = vge.jlqp + '/DBTJLQPInterface/user/getCaptcha';
		var INIT_URL = vge.jlqp + '/DBTJLQPInterface/sweep/getFailCount';
		var SEND_URL = vge.jlqp + '/DBTJLQPInterface/sweep/serialCode';
