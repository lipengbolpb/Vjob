$(document).ready(function () {
    // 接口
    var Port_Check = vge.jlqp + '/DBTJLQPInterface/user/getCaptcha'; //获取验证码接口
    var Port_Sub = vge.jlqp + '/DBTJLQPInterface/user/savePrize'; //大奖提交接口
    var Port_PrizeList = vge.jlqp + '/DBTJLQPInterface/gifts/queryPrizeList'; //大奖列表查询接口
    var Port_FindPrize = vge.jlqp + '/DBTJLQPInterface/user/findPrize'; //一等奖查询接口
    ...
    function getYzcode() {
        ...
        } else if ($('.doubleIdcard').val() === '' || $('.doubleIdcard').val().indexOf(' ') !== -1 || !getIdcardValidateCode($('.doubleIdcard').val()) || !reg2.test($('.doubleIdcard').val())) {
