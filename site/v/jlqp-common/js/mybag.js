...
var ONEPAGE_PORT = vge.jlqp + '/DBTJLQPInterface/gifts/queryAllGiftsList';
var SPACK_PORT = vge.jlqp + '/DBTJLQPInterface/gifts/getGiftspack';
var GiftsList_PORT = vge.jlqp + '/DBTJLQPInterface/gifts/queryPrizeList'; //大奖列表
var API_getCaptcha = vge.jlqp + '/DBTJLQPInterface/user/getCaptcha'; //获取验证码接口
var Port_Sub = vge.jlqp + '/DBTJLQPInterface/user/savePrize'; //大奖提交接口
...
var reg1 = /^1[0-9]{10}$/, //验证手机号
    ...
    // reg3 = /^[1-9][0-7]\d{4}((19\d{2}(0[13-9]|1[012])(0[1-9]|[12]\d|30))|(19\d{2}(0[13578]|1[02])31)|(19\d{2}02(0[1-9]|1\d|2[0-8]))|(19([13579][26]|[2468][048]|0[48])0229))\d{3}(\d|X|x)?$/,
    countdowntimer = null;
...
function prizeTj() {
    ...
    } else if ($('#idcard').val() === '' || $('#idcard').val().indexOf(' ') !== -1 ||!getIdcardValidateCode($('#idcard').val()) || !reg3.test($('#idcard').val())) {
...
var qrcode = new QRCode("qrcodepage", {
    ...
    canvas.width = size;
    canvas.height = size;
    qrcode.makeCode('HTTP://VJ1.TV/JL/'+$('#qrcode').val());
