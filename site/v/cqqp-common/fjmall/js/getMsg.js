(function () {
    'use strict';
    var CHECKCODE_PORT = vge.fjmall + '/DBTFJQHInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.fjmall + '/DBTFJQHInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.fjmall + '/DBTFJQHInterface/sweep/sweepQrcode';
    var PROJECT = 'fjmall';
    var PHONE_NUM = '4008-365-591';
    var NAME = '汾酒青花';
