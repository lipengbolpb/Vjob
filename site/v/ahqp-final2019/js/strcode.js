(function () {
    $(document).ready(function () {
        var CODE_URL = vge.ahqp + '/DBTAHQPInterface/user/getCaptcha';
        var INIT_URL = vge.ahqp + '/DBTAHQPInterface/sweep/getFailCount';
        var SEND_URL = vge.ahqp + '/DBTAHQPInterface/sweep/serialCode';
                ...
                if (jo.result.code === '0') {
                    ...
                    switch (jo.result.businessCode) {
                        ...
                        case '11':
                            ...
                            //location.replace('http://' + location.host + '/' + PROJECT + '/txo/getcash?bizcode=' + jo.result.businessCode);
                            location.replace('http://' + location.host + '/v/' + PROJECT + '/getcash.html?openid=' + openid + '&bizcode=' + jo.result.businessCode);
                            break;
                        case '12': // 可疑用户
