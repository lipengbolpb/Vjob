(function () {
    ...
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzAxNjMyMDA3NA==&mid=502316158&idx=1&sn=73d75b78ec8c87990b21afddefe6fe87&chksm=03f28f5b3485064d0840e0aa839121268cfc6c20356d78f8f02f10f15edfbac3fc410319caab#rd';
    ...
    $(document).ready(function () {
        if (grandPrizeType == 'p' || grandPrizeType == 'p') {//冬奥环球之旅
			...
			$('.warning p').html('温馨提示：以下内容须完整填写信息，否则无法兑奖。');
			$('.alert').html('咨询电话0551-62878695');
            init();
        }
        ...
        function init() {
            if (bizcode == 15) {
				...
				if(sessionStorage.checkStatus=='1'){
