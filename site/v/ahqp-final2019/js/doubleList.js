$(document).ready(function () {
    // 接口
    var Port_Check = vge.ahqp + '/DBTAHQPInterface/user/getCaptcha'; //获取验证码接口
    var Port_Sub = vge.ahqp + '/DBTAHQPInterface/user/savePrize'; //大奖提交接口
    var Port_QueryList = vge.ahqp + '/DBTAHQPInterface/gifts/queryPrizeList'; //大奖列表查询接口
    var Port_FindPrize = vge.ahqp + '/DBTAHQPInterface/user/findPrize'; //一等奖查询接口
