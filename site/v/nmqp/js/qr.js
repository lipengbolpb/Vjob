(function () {
    ...
    function subscribe() { //判断关注
        var requrl = 'http://' + vge.o3host + '/wx3/uinfo2?openid=' + openid + '&appid=' + vge.nmqpappid;
    ...
    function cb(jo) {
        ...
        if (jo.result.code == '0') {
            if(jo.result.businessCode=='30'){//大奖核销
                ...
                location.replace('http://' + location.host + '/v/nmqp/verification.html?bizcode=' + jo.result.businessCode);
                return false;
            }
            if(jo.reply){
                // 产品类型：0瓶、1罐
            ...
            switch (jo.result.businessCode) {
                case '0': // 普通奖
                    ...
                    location.replace('http://' + location.host + '/v/nmqp/getcash.html?bizcode='+jo.result.businessCode);
                    break;
                case '11': // 自己重复扫，普通奖
                    sessionStorage.totalAccountMoney = jo.reply.totalAccountMoney;
                    sessionStorage.currentMoney = jo.reply.currentMoney;
                    ...
                    break;
                case '12': // 
                    location.replace('http://' + location.host + '/v/nmqp/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                case '13': // 
                    location.replace('http://' + location.host + '/v/nmqp/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                ...
                case '15': //
                    ...
                    location.replace('http://' + location.host + '/v/nmqp/prize.html?bizcode=' + jo.result.businessCode);
                ...
                case '7': //一等奖或二等奖
                    ...
                    //特等奖类别
                    sessionStorage.grandPrizeType = jo.reply.grandPrizeType === undefined ? '' : jo.reply.grandPrizeType;
					if(['p','q','r','P','Q','R'].indexOf(jo.reply.grandPrizeType)!=-1){
						location.replace('http://' + location.host + '/v/nmqp/prize.html?bizcode=' + jo.result.businessCode);
					}else{
                ...
                default:
                    ...
                    location.replace('http://' + location.host + '/v/nmqp/fail.html?bizcode='+jo.result.businessCode);
            }
