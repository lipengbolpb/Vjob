(function(){
	'use strict';
	var API_findCheckUser = vge.sdqp + '/DBTSDQPInterface/checkUser/findCheckUser';
	var API_modifyCheckUser = vge.sdqp + '/DBTSDQPInterface/checkUser/modifyCheckUser';
	var API_getCaptcha = vge.sdqp + '/DBTSDQPInterface/user/getCaptcha';
