(function () {
    $(document).ready(function () {
        ...
        function sendcode() {
            ...
            vge.callJApi(javai, req, function (jo) {
                vge.clog('串码返回信息', [JSON.stringify(jo)]);
                ...
                if (jo.result.code === '0') {
                    if (jo.reply) {
                        ...
                        if (jo.reply && jo.reply.activityVersion == '1') {
                            PROJECT = 'sdqp-agt';
                        } else if (jo.reply && jo.reply.activityVersion == '2') {
                            PROJECT = 'sdqp-common2.0';
                        } else if (jo.reply && jo.reply.activityVersion == '3') {
                            PROJECT = 'sdqp-common2.0';
                        } else if (jo.reply && jo.reply.activityVersion == '4') {
                            PROJECT = 'sdqp-common2.0';
                        } else if (jo.reply && jo.reply.activityVersion == '5') {
                            PROJECT = 'sdqp-common2.0';
                        } else if (jo.reply && jo.reply.activityVersion == '6') {
                            PROJECT = 'sdqp20180130';
                        } else if (jo.reply && jo.reply.activityVersion == '7') {
                            PROJECT = 'sdqp-common2.0';
                        } else if (jo.reply && jo.reply.activityVersion == '8') {
                            PROJECT = 'sdqp-prs';
                        } else if (jo.reply && jo.reply.activityVersion == '9') {
                    ...
                    switch (jo.result.businessCode) {
                        ...
                        case '4': // 4 - 活动未开始
                            ...
                            $('.title').html('活动未开始');
                            $('.content').html('亲再等等哦~');
                            $('.batch').html(jo.reply.batchName + '<br />服务热线：18001240241');
                            break;
                        case '5': // 5 - 活动已结束
                            $('.slogan').css('display', 'none');
                            $('.mask').css('display', 'block');
                        ...
                        case '7': // 大奖
                            ...
                            if (jo.reply.grandPrizeType == 'p' || jo.reply.grandPrizeType == 'P' || jo.reply.grandPrizeType == 'q'|| jo.reply.grandPrizeType == 'Q') {
                                ...
                                location.replace('http://' + location.host + '/v/'+PROJECT+'/prize.html?bizcode=' + jo.result.businessCode);
                            } else if(jo.reply.grandPrizeType == 'v' || jo.reply.grandPrizeType == 'V') {//电音节
								location.replace('http://' + location.host + '/v/'+PROJECT+'/prize.html?bizcode=' + jo.result.businessCode);
                            } else if(jo.reply.grandPrizeType == 'w' || jo.reply.grandPrizeType == 'W') {//电音节
                                location.replace('http://' + location.host + '/v/'+PROJECT+'/prize.html?bizcode=' + jo.result.businessCode);
                            } else if(jo.reply.grandPrizeType == 'x' || jo.reply.grandPrizeType == 'X') {//电音节
                                location.replace('http://' + location.host + '/v/'+PROJECT+'/prize.html?bizcode=' + jo.result.businessCode);
                            } else if(jo.reply.grandPrizeType == 'u' || jo.reply.grandPrizeType == 'U') {//冬令营
                                location.replace('http://' + location.host + '/v/'+PROJECT+'/prize.html?bizcode=' + jo.result.businessCode);
                                ...
                                location.replace('http://' + location.host + '/v/'+ PROJECT +'/prize.html?bizcode=' + jo.result.businessCode);
                            } else if(jo.reply.grandPrizeType == 'p02' || jo.reply.grandPrizeType == 'P02') { //济宁市邹城市“青岛啤酒大礼包”(2020年4月16日-5月17日)
                                location.replace('http://' + location.host + '/v/'+ PROJECT +'/prize.html?bizcode=' + jo.result.businessCode);
                            }
						...
						case '21': // 逢19
						    ...
						    location.replace('http://' + location.host + '/sdqp-common2.0/txo/getcash?bizcode=' + jo.result.businessCode);
						    break;			
                        default:
                            if (jo.reply) {
