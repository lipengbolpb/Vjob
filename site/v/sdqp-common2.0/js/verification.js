'use strict';
(function(){
	var API_checkPrize = vge.sdqp + '/DBTSDQPInterface/checkUser/checkPrize';
	var openid = sessionStorage.openid;
	var exchangeDate = sessionStorage.exchangeDate;
	//显示信息
	...
	if(exchangeDate != 'undefined'){
		$(".dj_time").html('兑奖日期：')
		$('#endTime').val(sessionStorage.exchangeDate.split(' ')[0]);
	} else{
		$(".dj_time").html('兑奖截止：')
