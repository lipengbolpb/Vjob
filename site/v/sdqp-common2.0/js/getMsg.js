(function () {
    'use strict';
    var CHECKCODE_PORT = vge.sdqp + '/DBTSDQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.sdqp + '/DBTSDQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.sdqp + '/DBTSDQPInterface/sweep/sweepQrcode';
    var PROJECT = 'sdqp-common2.0';
    var PHONE_NUM = '0532-66985957';
    var NAME = '青岛啤酒畅享山东';
            ...
            switch (jo.result.businessCode) {
                ...
                case '7': // 大奖
                    ...
                    if (jo.reply.grandPrizeType == 'p' || jo.reply.grandPrizeType == 'P' || jo.reply.grandPrizeType == 'q'|| jo.reply.grandPrizeType == 'Q') {
                        location.replace('http://' + location.host + '/v/sdqp-common2.0/prize.html?bizcode=' + jo.result.businessCode);
