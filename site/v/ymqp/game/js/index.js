...
function myrandom() {
    if (diceFlag) {
        ...
        dom_diceThree[0].src = '/v/ymqp/game/img/r' + numArr[0] + '.png';
        dom_diceThree[1].src = '/v/ymqp/game/img/l' + numArr[1] + '.png';
        dom_diceThree[2].src = '/v/ymqp/game/img/l' + numArr[2] + '.png';

        dom_res3[0].src = '/v/ymqp/game/img/' + numArr[0] + '.png';
        dom_res3[1].src = '/v/ymqp/game/img/' + numArr[2] + '.png';
        dom_res3[2].src = '/v/ymqp/game/img/' + numArr[1] + '.png';
        ...
        dom_dice[0].src = '/v/ymqp/game/img/r' + numArr[0] + '.png';
        dom_dice[1].src = '/v/ymqp/game/img/l' + numArr[1] + '.png';
        dom_dice[2].src = '/v/ymqp/game/img/l' + numArr[2] + '.png';
        dom_dice[3].src = '/v/ymqp/game/img/l' + numArr[3] + '.png';
        dom_dice[4].src = '/v/ymqp/game/img/r' + numArr[4] + '.png';

        dom_res5[0].src = '/v/ymqp/game/img/' + numArr[0] + '.png';
        dom_res5[1].src = '/v/ymqp/game/img/' + numArr[1] + '.png';
        dom_res5[2].src = '/v/ymqp/game/img/' + numArr[2] + '.png';
        dom_res5[3].src = '/v/ymqp/game/img/' + numArr[3] + '.png';
        dom_res5[4].src = '/v/ymqp/game/img/' + numArr[4] + '.png';
