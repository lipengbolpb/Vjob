(function() {
	...
	window.onload = function() {
		...
		var RULE_URL =
			'https://mp.weixin.qq.com/s?__biz=MzIzMTA1NzgzNw==&mid=100000098&idx=1&sn=d086803a970cae6b686cbe5df0ada5df&chksm=68a8b1a05fdf38b6d7f6b18e31463f39439bcccda7251b34fab0204ce2109c3c2780eda37cf2#rd';
		// var EXPLAIN_URL = '';
		...
		if (bizcode == 11 || again == 'true') {
			...
			// 抵抗疫情
			if(new Date().getTime()>new Date(2020,1,4).getTime() && new Date().getTime()<new Date(2020,1,21).getTime() && sessionStorage.dayScanNum<3 ){//2020.2.4~2.20 每日两次
				setTimeout(function(){
