(function(){
	'use strict';
	var API_findCheckUser = vge.fjqp + '/DBTFJQPInterface/checkUser/findCheckUser';
	var API_modifyCheckUser = vge.fjqp + '/DBTFJQPInterface/checkUser/modifyCheckUser';
	var API_getCaptcha = vge.fjqp + '/DBTFJQPInterface/user/getCaptcha';
	...
	var reg1 = /^1[0-9]{10}$/, //验证手机号
	    reg2 = /^[0-9]{4}$/;	
	if(openid.lastIndexOf('#')==openid.length-1){//处理末尾包含#号的情况  莫名其妙的？？？
