(function () {
    'use strict';
    var CHECKCODE_PORT = vge.ahqp + '/DBTAHQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.ahqp + '/DBTAHQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.ahqp + '/DBTAHQPInterface/sweep/sweepQrcode';
    var PROJECT = 'ahqp';
