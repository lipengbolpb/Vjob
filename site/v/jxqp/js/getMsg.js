        ...
        if (jo.result.code == '0') {
            switch (jo.result.businessCode) {
                case '0':               // 普通奖
                    ...
                    location.replace('http://' + location.host + '/jxqp/txo/getcash?bizcode=' + jo.result.businessCode);
                    break;
                case '11':              // 自己重复扫，普通奖
                    sessionStorage.totalAccountMoney = jo.reply.totalAccountMoney;
                    sessionStorage.currentMoney = jo.reply.currentMoney;
                    ...
                    break;
                case '12':              // 可疑用户
                    location.replace('http://' + location.host + '/v/jxqp/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                case '13':              // 黑名单
                    location.replace('http://' + location.host + '/v/jxqp/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                ...
                case '7':              // 大奖
                    ...
                    location.replace('http://' + location.host + '/v/jxqp/prize.html?bizcode=' + jo.result.businessCode);
                    break;
                case '15':  //他人重复扫大奖
                    sessionStorage.grandPrizeType = jo.reply.grandPrizeType === undefined ? '' : jo.reply.grandPrizeType;
                ...
                default:
                    ...
                    location.replace('http://' + location.host + '/v/jxqp/fail.html?bizcode=' + jo.result.businessCode);
            }
