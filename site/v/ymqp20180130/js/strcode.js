$(document).ready(function () {
    let CODE_URL = vge.ymqp + '/DBTXYMQPInterface/user/getCaptcha';
    let INIT_URL = vge.ymqp + '/DBTXYMQPInterface/sweep/getFailCount';
    let SEND_URL = vge.ymqp + '/DBTXYMQPInterface/sweep/serialCode';
    let APPID = vge.ymqpappid;
    let PROJECT = 'ymqp20180130';
