(function () {
	'use strict';
    let CHECKCODE_PORT = vge.ymqp + '/DBTXYMQPInterface/user/getCaptcha';
    let SUBMESSAGE_PORT = vge.ymqp + '/DBTXYMQPInterface/user/updateUserInfoMobile';
    let SWEEP_PORT = vge.ymqp + '/DBTXYMQPInterface/sweep/sweepQrcode';
    let PROJECT = 'ymqp20180130';
    let PHONE_NUM = '0539-4636210';
    let NAME = '青岛啤酒激情银麦';
