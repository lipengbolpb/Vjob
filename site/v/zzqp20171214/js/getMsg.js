        ...
        if (jo.result.code == '0') {
            ...
            if (jo.result.versionCode) {
                if (jo.result.versionCode == '1.17.0214') {
                    ...
                    replace = '/v/zzqp20171214/getcash.html?bizcode=';
                    ...
                    replace = '/v/zzqp20170815/index.html?bizcode=';
                } else {
                    replace = '/v/zzqp20170815/index.html?bizcode=';
                }
            }
            switch (jo.result.businessCode) {
                ...
                case '12': // 可疑用户
                    if (jo.result.versionCode == '2') {
                        location.replace('http://' + location.host + '/v/zzqp20171214/getMsg.html?bizcode=' + jo.result.businessCode);
                    } else {
