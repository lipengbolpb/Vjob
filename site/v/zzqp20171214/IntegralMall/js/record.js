(function () {
    ...
    function userInfo(currentPage) { //获取商品数据
        var javai = vge.zzqp + '/DBTHNQPInterface/vpointsExchange/getExchangeRecord';
        var req = {
    ...
    function recordShow(recordList) {
        if (recordList.length < 1) {
            ...
            for (i = 0; i < recordList.length; i++) {
                if (recordList[i].exchangeChannel == '4' || recordList[i].exchangeChannel == '5') {
                    continue;
                }
                if (recordList[i].exchangeChannel == '2') { //抽奖
                    if (recordList[i].exchangeType == '1' || recordList[i].exchangeType == '2' || recordList[i].exchangeType == '3') {
                        ...
                        html += `<div class="list" exchangeId="${recordList[i].exchangeId}">
                            <img src="${vge.zzqpimg}/DBTHNQPPlatform${recordList[i].goodsUrl.split(',')[0]}"/>
                        ...
                        html += `<div class="list" exchangeId="${recordList[i].exchangeId}">
                            <img src="http://${location.host}/v/zzqp20171214/IntegralMall/img/point.jpg"/>
                        ...
                        html += `<div class="list" exchangeId="${recordList[i].exchangeId}">
                            <img src="http://${location.host}/v/zzqp20171214/IntegralMall/img/hb.jpg"/>
                        ...
                        html += `<div class="list" exchangeId="${recordList[i].exchangeId}">
                            <img src="http://${location.host}/v/zzqp20171214/IntegralMall/img/null.jpg"/>
                            <p class="name">谢谢惠顾</p>
                            <span>积分抽奖</span>
                            <p class="date">${recordList[i].exchangeTime}</p>
                        </div>`;
                        ...
                        html += `<div class="list" exchangeId="${recordList[i].exchangeId}">
                            <img src="http://${location.host}/v/zzqp20171214/IntegralMall/img/football.png"/>
                            <p class="name">${recordList[i].earnVpoints}积分</p>
                            <span>足球游戏</span>
                            <p class="date">${recordList[i].exchangeTime}</p>
                        </div>`;
    ...
    $('#content').on('click', '.list', function () {
        ...
        $('#content').load('person.html #details', function () {
            ...
            picArr = picUrl.split(',');
            $('.pic_box').append(`<li><img src="${vge.zzqpimg}/DBTHNQPPlatform${picArr[picArr.length-1]}" /></li>`);
            for (var i = 0; i < picArr.length; i++) {
                $('.pic_box').append(`<li><img src="${vge.zzqpimg}/DBTHNQPPlatform${picArr[i]}" /></li>`);
                $('.dot').append('<li></li>');
            }
            $('.pic_box').append(`<li><img src="${vge.zzqpimg}/DBTHNQPPlatform${picArr[0]}" /></li>`);
