(function() {
	...
	var params = {
		APPID: vge.jxqpappid, //公众号appid
		PROJECT: 'jxqp20180130', //项目名称
		SPACK_PORT: vge.common + '/vjifenInterface/gifts/getGiftspack', //提现接口
		RULE_URL: 'https://mp.weixin.qq.com/s?__biz=MzI3OTUzNzEzMQ==&mid=100000976&idx=1&sn=f6e69f2a997a91c16a02b8b5a298ed77&chksm=6b4770545c30f9429a5f9c388e74ec9be19c9548b3556ea240088054470da3cdb2d063e70f5e#rd', //活动规则
		EXPLAIN_URL: 'https://mp.weixin.qq.com/s?__biz=MzI3OTUzNzEzMQ==&mid=100000974&idx=1&sn=bc9893c75281e200e3083ba577606352&chksm=6b47704a5c30f95cf73b79b383a3854a364afaa5b0724df667c8c368761a8c8c7a32f8c45d9d#rd' //隐私说明
	}
					...
					if(weekSignPopup == 1 && weekSignEarnFlag != 1) { //每天首次 且未领取签到红包就会弹出提示
						if(weekSignEarnFlag == 2) {
							...
							$('.getSignCash').on('click', function() {
								...
								$('.content').css('display', 'block');
								$('.sign_title').attr('src', '/v/bxqp20180130/img2/sign_title_2.png');
								$('.sign_logo').css({
									'background': 'url(/v/bxqp20180130/img2/sign_ed.png) no-repeat right',
									'-webkit-background-size': ' auto 100%'
								});
								$('.sign_tip,#weekSignEarnMoney').css('display', 'block');
								$('.sign_cash').css({
									'background': 'url(/v/bxqp20180130/img2/sign_cash_open.png) no-repeat bottom',
									'-webkit-background-size': '100% auto'
								});
							});
						} else {
