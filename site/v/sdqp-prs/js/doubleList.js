$(document).ready(function () {
    // 接口
    var Port_Check = vge.sdqp + '/DBTSDQPInterface/user/getCaptcha'; //获取验证码接口
    var Port_Sub = vge.sdqp + '/DBTSDQPInterface/user/savePrize'; //大奖提交接口
    var Port_PrizeList = vge.sdqp + '/DBTSDQPInterface/gifts/queryPrizeList'; //大奖列表查询接口
    var Port_FindPrize = vge.sdqp + '/DBTSDQPInterface/user/findPrize'; //一等奖查询接口
