    ...
    function cb(jo) {
		...
		if(jo.result.code == '0'){
	        ...
	        case '0':               // 普通奖
				...
				// sessionStorage.isVpointsShop = '0';//不显示积分商城
	        ...
	        case '11':              // 自己重复扫，普通奖
				...
				sessionStorage.currentVpoints = jo.reply.currentVpoints;
				// sessionStorage.isVpointsShop = jo.reply.isVpointsShop;
				sessionStorage.brandIntroduceUrl = '/v/terminal/img/repscan-zj.png';
				location.replace('http://' + location.host + '/v/terminal/active.html?bizcode='+jo.result.businessCode);
				// location.replace('http://' + location.host + '/terminal/txo/getcash?bizcode='+jo.result.businessCode);
	            break;
	        case '7':              // 大奖
	        ...
	        case '19':              // 游客
	            ...
	            break;  
			case '23':
				location.replace('http://' + location.host + '/v/terminal/active_zj.html?bizcode='+jo.result.businessCode);
				break;
	        case '-1':              // 非销售人员
	        ...
	        default:
        		...
        		sessionStorage.earnTime = jo.reply.earnTime===undefined?'':jo.reply.earnTime;
        		sessionStorage.pmPhoneNum = jo.reply.pmPhoneNum==undefined?'':jo.reply.pmPhoneNum;
