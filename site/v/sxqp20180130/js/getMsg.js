(function () {
    let CHECKCODE_PORT = vge.sxqp + '/DBTSXQPInterface/user/getCaptcha';
    let SUBMESSAGE_PORT = vge.sxqp + '/DBTSXQPInterface/user/updateUserInfoMobile';
    let SWEEP_PORT = vge.sxqp + '/DBTSXQPInterface/sweep/sweepQrcode';
    let PROJECT = 'sxqp20180130';
    let PHONE_NUM = '0351-7896957';
    let NAME = '青岛啤酒乐享山西';
