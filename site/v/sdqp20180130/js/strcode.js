$(document).ready(function () {
    let CODE_URL = vge.sdqp + '/DBTSDQPInterface/user/getCaptcha';
    let INIT_URL = vge.sdqp + '/DBTSDQPInterface/sweep/getFailCount';
    let SEND_URL = vge.sdqp + '/DBTSDQPInterface/sweep/serialCode';
    let APPID = vge.sdqpappid;
