(function () {
	'use strict';
    let CHECKCODE_PORT = vge.sdqp + '/DBTSDQPInterface/user/getCaptcha';
    let SUBMESSAGE_PORT = vge.sdqp + '/DBTSDQPInterface/user/updateUserInfoMobile';
    let SWEEP_PORT = vge.sdqp + '/DBTSDQPInterface/sweep/sweepQrcode';
    let PROJECT = 'sdqp20180130';
    let PHONE_NUM = '0532-66985957';
    let NAME = '青岛啤酒畅享山东';
