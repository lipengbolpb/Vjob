                ...
                if (jo.result.code == '0') {
                    if (jo.result.businessCode === '0') {
                        ...
                        if (jo.reply.prizeImg.indexOf('R.png') != -1 || jo.reply.prizeImg.indexOf('r.png') != -1) {
							$('.doubleGetBtn').attr('src', '/v/hbqp-common3.0/img/20190423/double_prize.png');//青啤有一套
                            $('.doubleGet').show();
                            $('.doubleAlert').hide();
                        }else if(jo.reply.prizeImg.indexOf('/6.png') != -1){
							$('.doubleGetBtn').attr('src', '/v/hbqp-common3.0/img/20190423/double_prize_2.png');//李宗盛门票
                            $('.doubleGet').show();
                            $('.doubleAlert').hide();
                        }else{
							$('.doubleNone').show();
