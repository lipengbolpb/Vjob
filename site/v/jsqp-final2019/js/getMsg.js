(function () {
    'use strict';
    var CHECKCODE_PORT = vge.jsqp + '/DBTJSQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.jsqp + '/DBTJSQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.jsqp + '/DBTJSQPInterface/sweep/sweepQrcode';
