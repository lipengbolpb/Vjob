            ...
            vge.callJApi(javai, req, function (jo) {
                ...
                if (jo.result.code === '0') {
                    if (jo.reply) {
                        ...
                        } else if (jo.reply && jo.reply.activityVersion == '3') { //2109经典02版
                            PROJECT = 'jsqp-final2019';
                        }
						if (jo.reply.skuType) {
                    ...
                    if(jo.result.businessCode=='30'){//大奖核销
                    	...
                    	location.replace('http://' + location.host + '/v/jsqp/verification.html?bizcode=' + jo.result.businessCode);
                    	return false;
                    }
                    switch (jo.result.businessCode) {
                        case '0':
                            ...
                            if (PROJECT == 'jsqp-final2019' ) { //19年新上线项目采用扫点得流程
                        ...
                        case '2': // 2 - 该积分码已经被使用过
                            $('.sloganBox').css('display', 'none');
                            $('.mask').css('display', 'block');
                            //$('.err').attr('src', '/v/jsqp-common3.0/img/err_2.png');
                            $('.err').css('display', 'none');
                            $('.title').html('这个二维码已被扫');
                        ...
                        case '4': // 4 - 活动未开始
                            $('.sloganBox').css('display', 'none');
                            $('.mask').css('display', 'block');
                            //$('.err').attr('src', '/v/jsqp-common3.0/img/err_4.png');
                            $('.err').css('display', 'none');
                            $('.title').html('活动未开始');
                        ...
                        case '5': // 5 - 活动已结束
                            $('.sloganBox').css('display', 'none');
                            $('.mask').css('display', 'block');
                            //$('.err').attr('src', '/v/jsqp-common3.0/img/err_5.png');
                            $('.err').css('display', 'none');
                            $('.title').html('活动已截止');
                        ...
                        case '6': // 6 - 积分码异常(通常为服务器报错)
                            $('.sloganBox').css('display', 'none');
                            $('.mask').css('display', 'block');
                            //$('.err').attr('src', '/v/jsqp-common3.0/img/err_-1.png');
                            $('.err').css('display', 'none');
                            $('.title').html('系统升级中');
                        ...
                        case '7': // 大奖
                            ...
                            if (jo.reply.grandPrizeType=='1'||jo.reply.grandPrizeType=='2'||jo.reply.grandPrizeType.toUpperCase()=='P') {//冬奥环球之旅
                        ...
                        case '10': // 10-错误超过6次,请明天再试
                            $('.sloganBox').css('display', 'none');
                            $('.mask').css('display', 'block');
                            //$('.err').attr('src', '/v/jsqp-common3.0/img/err_6.png');
                            $('.err').css('display', 'none');
                            $('.title').html('您输入的次数太多');
