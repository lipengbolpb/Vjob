(function() {
	...
	var currentMoney = sessionStorage.currentMoney,
		...
		hbopenid = sessionStorage.openid,
	...
	var params = {
		APPID: vge.qpzjappid, //公众号appid
		PROJECT: 'zjqp20180130', //项目名称
		SPACK_PORT: vge.common + '/vjifenInterface/gifts/getGiftspack', //提现接口
		RULE_URL: 'http://mp.weixin.qq.com/s?__biz=MzI1NTQ5MzA2Mw==&mid=100000003&idx=1&sn=6a7dd1bcae7ec35f8776e6a292a814b1&chksm=6a3457ab5d43debd0242f9296daec0c6019b51a235778c97805836f18e70ae044999cf45eec7#rd', //活动规则
		EXPLAIN_URL: 'http://mp.weixin.qq.com/s?__biz=MzI1NTQ5MzA2Mw==&mid=100000005&idx=1&sn=e3a9e4ec229d970d429759cd14014433&chksm=6a3457ad5d43debbe4c4571cd37fda1682cd4cd5caab71faaf9931430143fb3d414cc39688c4#rd' //隐私说明
	}
					...
					if(weekSignPopup == 1 && weekSignEarnFlag != 1) { //每天首次 且未领取签到红包就会弹出提示
						if(weekSignEarnFlag == 2) {
							...
							$('.getSignCash').on('click', function() {
								...
								$('.content').css('display', 'block');
								$('.sign_title').attr('src', '/v/zjqp20180130/img2/sign_title_2.png');
								$('.sign_logo').css({
									'background': 'url(/v/zjqp20180130/img2/sign_ed.png) no-repeat right',
									'-webkit-background-size': ' auto 100%'
								});
								$('.sign_tip,#weekSignEarnMoney').css('display', 'block');
								$('.sign_cash').css({
									'background': 'url(/v/zjqp20180130/img2/sign_cash_open.png) no-repeat bottom',
									'-webkit-background-size': '100% auto'
								});
							});
						} else {
