...
const CHECKCODE_URL = vge.hnqp + '/DBTHuaNQPInterface/user/getCaptcha';
const SUBMESSAGE_URL = vge.hnqp + '/DBTHuaNQPInterface/user/savePrize';
const RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzA5MTMwNTkwNQ==&mid=502815128&idx=1&sn=efa305626504f5c24bf42c9ef43f0be1&chksm=08729b463f051250e5f97c9a8863080e9305954d8b3a52bd68115ef3048590d3eabffcde992b#rd';
const SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzA5MTMwNTkwNQ==&mid=502815130&idx=1&sn=fbcd593daf81c1a423394c3f5d0d93b2&chksm=08729b443f05125229916ba53d9be541f67a98a9df10651928a757240c4711bc6aa0e253c7d9#rd';

const dom_get = document.getElementsByClassName('yz')[0];

const reg1 = /^1[0-9]{10}$/, //验证手机号
...
$(document).ready(function () {
    ...
    function sub_message() { // 提交注册信息
        ...
        vge.callJApi(javai, req, function (jo) {
            if (jo.result.code === '0') {
                if (jo.result.businessCode === '0') {
                    title_tip('提 示', '您的中奖信息我们已经收到，请拨打<br> 0755-61800227联系我们进行身份核实', '我知道了');
                    $('.alert').html('温馨提示：您的信息已提交成功，请耐心等待主办方与您联系');
                    $('#btn').val('提交成功');
                    $('#btn').attr('disabled', 'true');
