$(document).ready(function () {
    const CODE_URL = vge.hnqp + '/DBTHuaNQPInterface/user/getCaptcha';
    const INIT_URL = vge.hnqp + '/DBTHuaNQPInterface/sweep/getFailCount';
    const SEND_URL = vge.hnqp + '/DBTHuaNQPInterface/sweep/serialCode';
    const APPID = vge.hnqpappid;
    const PROJECT = 'hnqp-common';
