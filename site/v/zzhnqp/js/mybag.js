(function () {
    'use strict';
    var PROJECT = 'zzhnqp';
    var ONEPAGE_PORT = vge.zzhnqp + '/DBTHNPZQPInterface/gifts/queryAllGiftsList';
    var SPACK_PORT = vge.zzhnqp + '/DBTHNPZQPInterface/gifts/getGiftspack';
    ...
    function ifremeber() {
        var requrl = 'http://' + vge.o3host + '/wx3/uinfo2?openid=' + openid + '&appid=' + vge.zzhnqpappid;
