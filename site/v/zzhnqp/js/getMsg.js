(function () {
    'use strict';
    var CHECKCODE_PORT = vge.zzhnqp + '/DBTHNPZQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.zzhnqp + '/DBTHNPZQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.zzhnqp + '/DBTHNPZQPInterface/sweep/sweepQrcode';
    var PROJECT = 'zzhnqp';
    var PHONE_NUM = '';
    var NAME = '青岛啤酒华中';
    ...
    document.getElementById('content').innerHTML = '您的账号存在可疑风险，为确保您的账号安全，<br>请长按识别下方公众号二维码<br>关注【' + NAME + '】公众号，联系客服';
