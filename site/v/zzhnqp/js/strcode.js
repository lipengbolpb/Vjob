(function () {
    $(document).ready(function () {
        var CODE_URL = vge.zzhnqp + '/DBTHNPZQPInterface/user/getCaptcha';
        var INIT_URL = vge.zzhnqp + '/DBTHNPZQPInterface/sweep/getFailCount';
        var SEND_URL = vge.zzhnqp + '/DBTHNPZQPInterface/sweep/serialCode';
        var APPID = vge.zzhnqpappid;
        var PROJECT = 'zzhnqp';
        var PHONE_NUM = '15378785617';
