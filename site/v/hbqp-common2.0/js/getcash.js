(function () {
    ...
    var PROJECT = 'hbqp-common2.0';
    var RULE_URL = 'https://mp.weixin.qq.com/s?__biz=MzI5NjQ4MDMyNg==&mid=100000829&idx=1&sn=ee65542a8e7eee12cdb55a881c671135&chksm=6c42ff145b3576021415525daefe7d3e4bfc0d36c97ee7b10760b2830f65a20bc36cd328fdd1#rd';
    var EXPLAIN_URL = 'https://mp.weixin.qq.com/s?__biz=MzI5NjQ4MDMyNg==&mid=100000591&idx=1&sn=bb1f9ddbd803972c6e4d3ae5acc738eb&chksm=6c42f8665b3571702f2551eb663132e4daa3bac72a1dc964f005a2528605a22ead22752eb90f#rd';
    /* 定义各项参数 */
    ...
    (function () {
        if (Number(currentMoney) == 0) { //中奖金额为0
            $('.congratulate').html('离红包只差一点点<br>再扫一支试试');
            $('.congratulate').css({
                'margin': '1rem auto 0',
                'fontSize': '0.9rem'
            });
        ...
        if (bizcode == 11 || again == 'true') { //重复扫
            ...
            if (sessionStorage.earnTime == '') {
                $('.earn').html('您已扫过这支酒<br>并获得<span class="earnMoney">¥' + currentMoney + '元</span>');
            } else {
                $('.earn').html('您已于<span class="earnTime">' + earnTime + '</span>扫过这支酒<br>并获得<span class="earnMoney">¥' + currentMoney + '元</span>');
            }
        } else {
            if (Number(totalAccountMoney) >= 1) {
                $('.notice').html('温馨提示：您的红包累计金额为' + totalAccountMoney + '元，<br>点击上方按钮把钱拿走吧！');
    ...
    $('.hbGet,.open').on('touchstart', function () {
        ...
        setTimeout(function () {
            ...
            $('.cash').fadeIn(600, function () {
				...
				if(doublePrize.doublePrizeLottery != '1'){
					// 联通流量链接
