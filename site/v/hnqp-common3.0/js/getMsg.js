(function () {
    'use strict';
    var CHECKCODE_PORT = vge.hnqp + '/DBTHuaNQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.hnqp + '/DBTHuaNQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.hnqp + '/DBTHuaNQPInterface/sweep/sweepVerify';
    var PROJECT = 'hnqp-common3.0';
    var PHONE_NUM = '0898-68542005';
    var NAME = '青岛啤酒华南';
    ...
    document.getElementById('content').innerHTML = '您的账号存在可疑风险，为确保您的账号安全，<br>请长按识别下方公众号二维码<br>关注【' + NAME + '】公众号';
