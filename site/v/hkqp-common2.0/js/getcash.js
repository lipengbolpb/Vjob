(function () {
    ...
    var PROJECT = 'hkqp-common2.0';
    var RULE_URL = 'https://mp.weixin.qq.com/s?__biz=MzU0MTU3MTYzOA==&mid=100000485&idx=1&sn=39b8cd6bafcd44c5edb282e2cacbf709&chksm=7b26adbc4c5124aaca6be59aa50c1969c49cd4f32fab9c6909d04d814fab5f02e9f1bd57d049#rd';
    var EXPLAIN_URL = 'https://mp.weixin.qq.com/s?__biz=MzU0MTU3MTYzOA==&mid=100000487&idx=1&sn=7bd98a56038a805cfeeb6fa36ee8a619&chksm=7b26adbe4c5124a8ca1b7f9a8ac073405a18e77c909aca52a852999f9724988649085f0ef599#rd';
    /* 定义各项参数 */
        ...
        if (bizcode == 11 || again == 'true') { //重复扫
			...
			if((sessionStorage.skukey=='241510936-002'||sessionStorage.skukey=='241510936-005')&&sessionStorage.isHotAreaName=='true'){
				...
				if((sessionStorage.hotAreaName == '三亚大区'||sessionStorage.hotAreaName == '三亚大区捆绑升级')&&skuList.indexOf(sessionStorage.skukey)!=-1&&sessionStorage.isHotAreaName=='true'){
					if (sessionStorage.skukey == '241510936-001' || sessionStorage.skukey == '241510936-007' || sessionStorage.skukey == '241510936-004') {
        ...
        if (STRCODE == 'true') { //从输入串码进入，模拟拆红包
            ...
            setTimeout(function () {
                ...
                $('.cash').fadeIn(600, function () {
                    ...
                    sale();
                    // 广告
                    // if (now <= 1538928000000) { //10.8日凌晨00:00:00
                    //     $('.active').css('display', 'block');
            ...
            $.ajax({
                ...
                success: function (res, status, xhr) {
                    ...
                    if (res.result.code == '0') {
						vge.clog('拆红包返回', [JSON.stringify(res)]);
                        var replace = PROJECT;
...
function sign() { //混合签到功能
    ...
    var APPID = vge.hkqpappid;
    var PROJECT = 'hkqp-common2.0';
    var imgUrl = '/v/hkqp-common2.0/';
    var _host = vge.hkqpimg + '/DBTHaiNQPplatform';
    var iconFlag = true;
    ...
    var tpl_1 = '<div class="swiper">' +
        ...
        '<img src="/v/hkqp-common2.0/img/sign/hb.png" class="signHb" style="display: block;">' +
        '</div>';
