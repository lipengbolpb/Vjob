...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [['undo', 'redo', '|', 'fontsize', '|', 'blockquote','horizontal', '|', 'bold', 'italic', 'underline','forecolor', 'backcolor','|','removeformat', 'formatmatch','source'],['indent','justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|','rowspacingtop', 'rowspacingbottom', 'lineheight', '|', 'insertorderedlist', 'insertunorderedlist', '|','imagenone', 'imageleft', 'imageright', 'imagecenter']]
