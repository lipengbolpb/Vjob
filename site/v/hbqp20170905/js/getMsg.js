    ...
    function cbk(jo) {
		if(jo.result.code == '0'){
            ...
            case '7':              // 大奖
                ...
                location.replace('http://' + location.host + '/v/hbqp20170905/prize.html?bizcode='+jo.result.businessCode);
                break;
            case '15':  //他人重复扫大奖
                sessionStorage.grandPrizeType = jo.reply.grandPrizeType===undefined?'':jo.reply.grandPrizeType;
	        ...
	        default:
				...
				location.replace('http://' + location.host + '/v/hbqp20170905/fail.html?bizcode='+jo.result.businessCode);
	        }	
