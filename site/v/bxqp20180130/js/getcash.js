(function() {
	...
	var params = {
		APPID: vge.bxqpappid, //公众号appid
		PROJECT: 'bxqp20180130', //项目名称
		SPACK_PORT: vge.common + '/vjifenInterface/gifts/getGiftspack', //提现接口
		RULE_URL: 'https://mp.weixin.qq.com/s/s0_hzI5swUuDAZCr2dJA8Q', //活动规则
		EXPLAIN_URL: 'https://mp.weixin.qq.com/s/I7YHxSCNmMqPEmi5olXFmg' //隐私说明
	}
