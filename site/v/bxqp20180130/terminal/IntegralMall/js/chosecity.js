(function () {
        ...
        if (v && index >= 0 || !v) {
            if (dsy.Exists(str)) {
                ...
                if (v == 1) {
                    ...
                    $('#chose_address').val($("#" + s[0]).html()+ ' ' + $("#" + s[1]).html()+ ' '+ dsy.Items[insertarr][index]);
    ...
    $("#chose_address").click(function () {
        if ($("#chose_address").length!==0) {
            $(".chose-address").show();
            $("#chose_address").blur();
            var winheight = document.documentElement.clientHeight;
            $(".swiper-container").height((winheight - 69 - parseInt($(".martotop").css("marginTop"))) + 'px');
            if ($("#chose_address").val()=='') {
                // _init_area();
                // 
                change(0);
            } else{
                var thecity=$("#chose_address").val().split(" ");//['北京','北京','海淀区']
                opt0=thecity;
    ...
    $("#chose_box_close").click(function () {
        $(".chose-address").hide();
    });
