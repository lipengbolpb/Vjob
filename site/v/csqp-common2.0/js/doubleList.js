$(document).ready(function () {
    // 接口
    var Port_Check = vge.csqp + '/DBTHuNanQPInterface/user/getCaptcha'; //获取验证码接口
    var Port_Sub = vge.csqp + '/DBTHuNanQPInterface/user/savePrize'; //大奖提交接口
    var Port_QueryList = vge.csqp + '/DBTHuNanQPInterface/gifts/queryPrizeList'; //大奖列表查询接口
    var Port_FindPrize = vge.csqp + '/DBTHuNanQPInterface/user/findPrize'; //一等奖查询接口
    ...
    function getYzcode() {
        ...
        } else if (!reg2.test($('.doubleIdcard').val())) {
            title_tip('提 示', '请输入正确的身份证号！~', '我知道了');
