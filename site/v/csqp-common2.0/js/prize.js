(function () {
    ...
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzA4MzMxMDgyNA==&mid=300055174&idx=1&sn=e126844a6706e9344870a57d8d4aeb75&chksm=0beebb013c9932170f857bdf943316525ed878e3702ef805f631025bb183ee0a3b28f519585e#rd';
    var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzA4MzMxMDgyNA==&mid=300054527&idx=1&sn=789ca2f60c02c13873fc1485720677a0&chksm=0beeb6783c993f6eb2446e453efe9d91e3702994ac54948635413b95577c5128f6f0d7496f27#rd';
    ...
    var openid = sessionStorage.openid === undefined ? '' : sessionStorage.openid,
        ...
        expireTime = sessionStorage.expireTime === undefined ? '' : sessionStorage.expireTime,
    ...
    if(expireTime != '') {
        var exchangeDateOne = sessionStorage.expireTime.split('-');
        expireTime = exchangeDateOne[0] + '年'+ exchangeDateOne[1] + '月'  + exchangeDateOne[2]+ '日';  
    }
    ...
    $(document).ready(function () {
        ...
        $('#btn').on('click', function () {
            if (!$('.name').val() == '' && !$('.name').val().indexOf(' ') !== -1&& reg1.test($('.tel').val()) && reg2.test($('.idcard').val()) && reg3.test($('.code').val())) {
                send();
            }
        });
