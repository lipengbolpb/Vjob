(function () {
    ...
    var RULE_URL = 'https://mp.weixin.qq.com/s?__biz=MzI2MDk3NTY3NQ==&mid=100000034&idx=1&sn=17ffb5d6b31daf70ae960d49363d6099&chksm=6a603c765d17b560bf298e82ad0ac3b5c38b181cab4a0d9fe757791b13217890e02f13f8ca00#rd';
            ...
            if (needAlert) { //需要弹窗推广
                var timer = setTimeout(function () {
                    ...
                    if (weekSignPopup == 1 && weekSignEarnFlag != 1) { //每天首次 且未领取签到红包就会弹出提示
                        ...
                        if (act) {
                            $('#active').find('img').attr('src', '/v/xaqp-cs/img/active_20180518.png');
                            $('#active').css('display', 'block');
                            $('#active').on('click', function () {
