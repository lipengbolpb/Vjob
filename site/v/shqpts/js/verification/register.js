(function(){
	'use strict';
	var API_findCheckUser = vge.shqp + '/DBTSHQPInterface/checkUser/findCheckUser';
	var API_modifyCheckUser = vge.shqp + '/DBTSHQPInterface/checkUser/modifyCheckUser';
	var API_getCaptcha = vge.shqp + '/DBTSHQPInterface/user/getCaptcha';
