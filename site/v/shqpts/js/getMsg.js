(function () {
    'use strict';
    var CHECKCODE_PORT = vge.shqp + '/DBTSHQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.shqp + '/DBTSHQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.shqp + '/DBTSHQPInterface/sweep/sweepQrcode';
        ...
        if (jo.result.code == '0') {
            ...
            switch (jo.result.businessCode) {
                ...
                case '11': // 自己重复扫，普通奖
                    ...
                    location.replace('http://' + location.host + '/v/shqpts/getcash?bizcode=' + jo.result.businessCode);
                    break;
                case '12': // 
