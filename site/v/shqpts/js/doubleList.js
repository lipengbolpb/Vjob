$(document).ready(function () {
    // 接口
    var Port_Check = vge.shqp + '/DBTSHQPInterface/user/getCaptcha'; //获取验证码接口
    var Port_Sub = vge.shqp + '/DBTSHQPInterface/user/savePrize'; //大奖提交接口
    var Port_PrizeList = vge.shqp + '/DBTSHQPInterface/gifts/queryPrizeList'; //大奖列表查询接口
    var Port_FindPrize = vge.shqp + '/DBTSHQPInterface/user/findPrize'; //一等奖查询接口
