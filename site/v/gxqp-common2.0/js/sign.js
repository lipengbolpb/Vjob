...
var imgUrl = '/v/gxqp-common2.0/';
var _host = vge.gxqpimg + '/vjifenGXQPplatform';
var iconFlag = true;
...
function sign() { //混合签到功能
    var tpl_1 = '<div class="swiper">' +
        ...
        '<img src="/v/gxqp-common2.0/img/sign/hb.png" class="signHb" style="display: block;">' +
        '</div>';
    ...
    if (weekSignFlag === '1') { //开启签到功能，则显示开关按钮
        ...
        for (var i = 0; i < signCogAry.length; i++) {
            ...
            if (signCogAry[i].signEarnFlag == '0') {
                ...
                $('.jump').on('click', function () {
                    window.location.href = 'https://hd.faisco.cn/12713933/THvgSnox06DN2tqVbrg_zQ/load.html?style=24';
                });
                $('#sign_logo').css('background-image', 'url("' + imgUrl + 'img/sign/sign_logo.png?v=1")');
                iconFlag = false;
            }
        ...
        function slide(index) {
            ...
            if (signCogAry[index].periodType == '0') { //周
                $('.bgTop').attr('src', imgUrl + 'img/sign/bg_top_3.png');
