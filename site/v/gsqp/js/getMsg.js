        ...
        if (jo.result.code == '0') {
            switch (jo.result.businessCode) {
                ...
                case '11': // 自己重复扫，普通奖
                    ...
                    break;
                case '12': // 可疑用户
                    location.replace('http://' + location.host + '/v/gsqp/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                case '13': // 黑名单
                    location.replace('http://' + location.host + '/v/gsqp/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                ...
                case '7': // 大奖
                    ...
                    location.replace('http://' + location.host + '/v/gsqp/prize.html?bizcode=' + jo.result.businessCode);
                    break;
                case '15': //他人重复扫大奖
                    sessionStorage.grandPrizeType = jo.reply.grandPrizeType === undefined ? '' : jo.reply.grandPrizeType;
                ...
                default:
                    ...
                    location.replace('http://' + location.host + '/v/gsqp/fail.html?bizcode=' + jo.result.businessCode);
            }
