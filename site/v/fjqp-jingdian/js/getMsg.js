(function () {
    'use strict';
    var CHECKCODE_PORT = vge.fjqp + '/DBTFJQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.fjqp + '/DBTFJQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.fjqp + '/DBTFJQPInterface/sweep/sweepQrcode';
    var PHONE_NUM = '0592-3663948';
    var NAME = '青岛啤酒东南营销';
        ...
        if (jo.result.code == '0') {
            switch (jo.result.businessCode) {
                case '0': // 普通奖
                    ...
                    location.replace('http://' + location.host + '/v/fjqp-jingdian/getcash.html?bizcode='+jo.result.businessCode);
                    break;
                case '11': // 自己重复扫，普通奖
                    sessionStorage.totalAccountMoney = jo.reply.totalAccountMoney;
                    sessionStorage.currentMoney = jo.reply.currentMoney;
                    ...
                    location.replace('http://' + location.host + '/v/fjqp-jingdian/getcash?bizcode=' + jo.result.businessCode);
                    break;
                case '12': //
                    location.replace('http://' + location.host + '/v/fjqp-jingdian/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                case '13': //
                    location.replace('http://' + location.host + '/v/fjqp-jingdian/getMsg.html?bizcode=' + jo.result.businessCode);
                    break;
                ...
                case '15': //
                    ...
                    location.replace('http://' + location.host + '/v/fjqp-jingdian/prize.html?bizcode=' + jo.result.businessCode);
                ...
                default:
                    ...
                    location.replace('http://' + location.host + '/v/fjqp-jingdian/fail.html?bizcode='+jo.result.businessCode);
            }
