$(document).ready(function () {
    // 接口
    var Port_Check = vge.fjqp + '/DBTFJQPInterface/user/getCaptcha'; //获取验证码接口
    var Port_Sub = vge.fjqp + '/DBTFJQPInterface/user/savePrize'; //大奖提交接口
    var Port_PrizeList = vge.fjqp + '/DBTFJQPInterface/gifts/queryPrizeList'; //大奖列表查询接口
    var Port_FindPrize = vge.fjqp + '/DBTFJQPInterface/user/findPrize'; //一等奖查询接口
