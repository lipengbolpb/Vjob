(function () {
    $(document).ready(function () {
        var CODE_URL = vge.csqp + '/DBTHuNanQPInterface/user/getCaptcha';
        var INIT_URL = vge.csqp + '/DBTHuNanQPInterface/sweep/getFailCount';
        var SEND_URL = vge.csqp + '/DBTHuNanQPInterface/sweep/serialCode';
        var APPID = vge.csqpappid;
        var PROJECT = 'csqp-FIFA';
        var PHONENUM = '13011121918'; //活动未开始电话
