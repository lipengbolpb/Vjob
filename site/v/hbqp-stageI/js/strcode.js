        ...
        function dot() {
            ...
            if (!status) { //不需要验证码
                ...
                if (!reg1.test($('#str_code').val().trim())) {
                    title_tip('提 示', '请填写正确的箱盖串码哦！~', '我知道了');
                ...
                if (jo.result.code === '0') {
                    if (jo.reply) {
                        ...
                        if (jo.reply && jo.reply.activityVersion == '3') {
                            PROJECT = 'hbqp20180130';
                        } else if (jo.reply && jo.reply.activityVersion == '2') {
                            PROJECT = 'hbqp20180130';
                        } else if (jo.reply && jo.reply.activityVersion == '4') {
                            PROJECT = 'hbqp-common2.0';
                        } else if (jo.reply && jo.reply.activityVersion == '5') { //世界杯
                            PROJECT = 'hbqp-common3.0';
                        } else if (jo.reply && jo.reply.activityVersion == '6') { //经典罐装
                            PROJECT = 'hbqp-common2.0-tin';
                        } else if (jo.reply && jo.reply.activityVersion == '7') { //崂山瓶装
                            PROJECT = 'hbqp20190513';
                        } else if (jo.reply && jo.reply.activityVersion == '8') { //崂山罐装 ==>一期纸箱板
                            PROJECT = 'hbqp-stageI';
                        }
                    }
                    switch (jo.result.businessCode) {
                        ...
                        case '11':
                            ...
                            break;
                        case '12': // 可疑用户
                            sessionStorage.sweepstr = $('#str_code').val();
                        ...
                        case '17': //酒品已过期
                            ...
                            $('.content').html('您扫的这箱酒<br />所属产品批次活动已结束');
                            $('.err').css('display', 'none');
                            $('.title').html('');
                            $('#btn').css({
                                'backgroundColor': '#e5e5e5',
