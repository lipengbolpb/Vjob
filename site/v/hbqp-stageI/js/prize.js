(function () {
    ...
    var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI5NjQ4MDMyNg==&mid=100001182&idx=1&sn=6e8c2a427e01fd9153ec15f9cfa8836a&chksm=6c42feb75b3577a11e62b7d89833121f2568b3feb7a0fc261215a1cf35bcd1031d27146145d9#rd';
    var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzI5NjQ4MDMyNg==&mid=100000671&idx=1&sn=9eef3689e429c5dfc94ce306e85fc8b4&chksm=6c42f8b65b3571a0db0790d55acd1b1a7f6fade0a15236d5756c20331e2a8842eb55795e25e0#rd';
    var xcSchedule = "https://mp.weixin.qq.com/s?__biz=MzI5NjQ4MDMyNg==&mid=100001129&idx=1&sn=e2a5f7bf0a409ddba14221e8b4cd7753&chksm=6c42fe405b357756798a06551d5d9a5ac53398785aee08dfea2a39436fe81879749c7ef3420c#rd";
    ...
    $(document).ready(function () {
        ...
        if (grandPrizeType == 'U' || grandPrizeType == 'u' ) {
            // U等奖-冬奥冰雪冬令营  二等奖
            $('.worldTravel').css('display','none');
            $('.worldTravelInfo').css('display','none');

            $('.warning.normalPrizeTip').css('display','block');
        ...
        // 冬奥环球之旅
        $('.travelWay').on('click', function () {
            $('.change').css('display', 'block');
        });
        // 冬奥冰雪冬令营
        $('#normalWay').on('click',function(){
            window.location.href = xcSchedule;
        });
