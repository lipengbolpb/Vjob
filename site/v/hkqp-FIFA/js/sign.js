...
var weekSignFlag = '', //是否开户自然周签到，1:开启、0或空:关闭
    weekSignDays = '', //当前周已签到周几集合
    weekSignEarnFlag = '', //周签到红包是否已领取，1:已领取、0未领取  2领取签到红包
    weekSignEarnMoney = '', //周签到红包金额
    weekSignLimitDay = '', //周签到天数限制
    weekSignDiffDay = '', //周签到还差天数
    weekSignPopup = '', //自然周签到弹出提示，1:弹出提示、0或空:不弹出"
    weekSignPercent = '', //周签到完成百分比
    totalAccountMoney = '';
var args = vge.urlparse(location.href),
    bizcode = args.bizcode,
    again = sessionStorage.again;
if (bizcode == 11 || again == 'true') {
    $('.sign_logo').css('display', 'none'); //签到按钮
} else {
    ...
    //     }, 2000);
    // });
    var timmerSign = setInterval(function () {
