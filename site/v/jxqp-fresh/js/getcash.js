(function () {
    ...
    var PROJECT = 'jxqp-fresh';
    var RULE_URL = 'https://mp.weixin.qq.com/s?__biz=MzI3OTUzNzEzMQ==&mid=100001854&idx=1&sn=0b8f1636d831730899b4d85daedfe6da&chksm=6b477cba5c30f5ac4a146d226abdf38cedb02e8e4d55ba88c07f916151db1e77c18983b97f9a#rd';
    var EXPLAIN_URL = 'https://mp.weixin.qq.com/s?__biz=MzI3OTUzNzEzMQ==&mid=100001856&idx=1&sn=2a9746346eaa6b512aec9a373268ec79&chksm=6b477cc45c30f5d20bff5c170dfc62f7811a7b7827a400d66958afcb5f1987eb87c6776897b8#rd';
    /* 定义各项参数 */
    ...
    (function () {
        if (Number(currentMoney) == 0) { //中奖金额为0
            $('.congratulate').html('再喝一瓶试试看');
            $('.prize').html('你离红包只差<br>一点点');
        } else {
        ...
        setTimeout(function () {
            ...
            $('.cash').fadeIn(600, function () {
                setTimeout(function(){
					...
					if (nowTime < 1538956800000) { //10.8 8:00
