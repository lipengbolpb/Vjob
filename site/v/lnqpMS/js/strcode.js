(function () {
    $(document).ready(function () {
        var CODE_URL = vge.lnqp + '/DBTSDQPInterface/user/getCaptcha';
        var INIT_URL = vge.lnqp + '/DBTSDQPInterface/sweep/getFailCount';
        var SEND_URL = vge.lnqp + '/DBTSDQPInterface/sweep/serialCode';
