(function () {
    'use strict';
    var CHECKCODE_PORT = vge.lnqp + '/DBTSDQPInterface/user/getCaptcha';
    var SUBMESSAGE_PORT = vge.lnqp + '/DBTSDQPInterface/user/updateUserInfoMobile';
    var SWEEP_PORT = vge.lnqp + '/DBTSDQPInterface/sweep/sweepQrcode';
    var PROJECT = 'lnqp';
