(function () {
    ...
    var PROJECT = 'lnqp';
    var RULE_URL = 'https://mp.weixin.qq.com/s?__biz=MzA3MTA2MjM3Mw==&mid=503561525&idx=1&sn=e50a6f9346316699bfc97fc5a144d448&chksm=04c45b3f33b3d2296c92ea92d650b9a662f32e490a881228023bc33f6371037e900cd952ccb0#rd';
    var EXPLAIN_URL = '';
    /* 定义各项参数 */
    ...
    if (activityVersion == '2') {
        ...
        $('.slogan').attr('src', '/v/lnqp/img/slogan.png');
        $('.beer').attr('src', '/v/lnqpMS/img/bear-2.png');
        // //活动规则
        // $('.rule').on('click', function () {
        ...
        $('.slogan').attr('src', '/v/lnqp/img/slogan.png');
        $('.beer').attr('src', '/v/lnqpMS/img/bear-3.png');
        // //活动规则
        // $('.rule').on('click', function () {
        ...
        $('.slogan').attr('src', '/v/lnqp/img/slogan.png');
        $('.beer').attr('src', '/v/lnqpMS/img/bear-4.png');
        // //活动规则
        // $('.rule').on('click', function () {
        ...
        $('.slogan').attr('src', '/v/lnqp/img/slogan.png');
        $('.beer').attr('src', '/v/lnqpMS/img/bear-5.png');
        // //活动规则
        // $('.rule').on('click', function () {
