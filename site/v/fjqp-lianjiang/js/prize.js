(function() {
	...
	var RULE_HREF = 'https://mp.weixin.qq.com/s?__biz=MzIzMTA1NzgzNw==&mid=100000076&idx=1&sn=4f7afea8a8a5e97a84da7b7e88838516&chksm=68a8b18e5fdf38982d794f9c4cfb61e13ee49f8a028d545e23266eb212870e7848bd435a1f74#rd';
	var SECRET_HREF = 'https://mp.weixin.qq.com/s?__biz=MzIzMTA1NzgzNw==&mid=100000078&idx=1&sn=d2fdcb402ce87377b97fbef0c3231fef&chksm=68a8b18c5fdf389a94911dd8dfc07e4bb9bd77051cffacf65bbeb410fb73dadd0fcb96be38f4#rd';
	...
	if(grandPrizeType == 'p' || grandPrizeType == 'P') { //俄罗斯之旅
		$('.repcash .slogan').attr('src', '/v/fjqp-lianjiang/img/prize-ship-slogan2.png');
		$('.top .slogan').attr('src', '/v/fjqp-lianjiang/img/prize-ship-slogan.png');
		...
		$('.title p').html('畅赢奖');
		$('.content').html(`<p>俄罗斯之旅1次(价值4999元，共1000个，中奖率:0.001%)</p>
                <p>活动区域：全国
                    <br>活动截止时间：2018年08月30日
                    <br>兑奖截止时间：2018年09月30日`);
	} else if(grandPrizeType == 'q'||grandPrizeType == 'Q') { //青啤1903
		$('.top .slogan').attr('src', '/v/fjqp-lianjiang/img/prize-ship-slogan3.png');
		$('.prize_box').css('display', 'block');
		$('.prize_box p').html('青岛啤酒330ml经典1903*24罐啤一件');
		$('.prize_box img,.info .slogan,.repcash .slogan').attr('src', '/v/fjqp-lianjiang/img/prize-ship-1903.png');
		$('.title p').html('欢聚奖');
		$('.content').html(`<p>青岛啤酒330ml经典1903*24罐啤一件，（价值120元）</p>
                <p>活动区域：福建省
                    <br>兑奖截止时间：2019年09月29日</p>`);
		$('.warning p').html('温馨提示：请尽快拨打0591-26163972核实中奖者身份信息，以下信息须完整填写信息，否则无法兑奖。');
		$('.address').css('display', 'block');
		$('.change ul').html(`<li>青岛啤酒330ml经典1903*24罐啤一件中奖者请拨打兑奖咨询电话：0591-26163972咨询兑奖事宜。逾期未要求兑付或逾期中出的奖项将不再兑付。</li>
                    <li>青岛啤酒330ml经典1903*24罐啤一件中奖者需提供完整的中奖纸箱及对应二维码，以及本人身份证复印件供我公司或我公司委托的第三方核实确认，待有奖拉环真实性及中奖者身份信息确认后即可安排兑付奖品。</li>
