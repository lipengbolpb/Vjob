    ...
    function sendcode() {
        ...
        vge.callJApi(javai, req, function(jo) {
	        ...
	        case '0':               // 普通奖
                ...
                sessionStorage.earnTime = jo.reply.earnTime===undefined?'':jo.reply.earnTime;
				location.replace('http://' + location.host + '/bxqp/txo/getcash?bizcode='+jo.result.businessCode);
	            break;
	        case '11':              // 自己重复扫，普通奖
				sessionStorage.totalAccountMoney = jo.reply.totalAccountMoney;
				sessionStorage.currentMoney = jo.reply.currentMoney;
	            ...
	            break;
	        case '12':              // 可疑用户
				location.replace('http://' + location.host + '/v/bxqp/getMsg.html?bizcode='+jo.result.businessCode);
	            break;    
	        case '13':              // 黑名单
				location.replace('http://' + location.host + '/v/bxqp/getMsg.html?bizcode='+jo.result.businessCode);
	            break;
            ...
            case '7':              // 大奖
                ...
                location.replace('http://' + location.host + '/v/bxqp/prize.html?bizcode='+jo.result.businessCode);
                break;
            case '15':  //他人重复扫大奖
                sessionStorage.grandPrizeType = jo.reply.grandPrizeType===undefined?'':jo.reply.grandPrizeType;
	        ...
	        case '-1':              // 升级中
	        	...
	        	pic_tip.src = '/v/bxqp/img/fail_tip_-1.png?v=1';
	        	time.innerHTML = '稍安勿躁，敬请关注';
	            break; 
	        case '1':      // 不存在
	        	mark.style.display = 'block';
	        	$('.slogan').css('display','none');
	        	pic_tip.src = '/v/bxqp/img/fail_tip_3.png?v=1.1';
	        ...
	        case '2':              // 被扫过
				if(jo.reply){
					mark.style.display = 'block';
					$('.slogan').css('display','none');
					pic_tip.src = '/v/bxqp/img/fail_tip_2.png?v=1';
	        ...
	        case '3':              // 过期
	        	...
	        	pic_tip.src = '/v/bxqp/img/fail_tip_3.png?v=1';
	            break; 
	        case '4':              // 未开始
				mark.style.display = 'block';
				$('.slogan').css('display','none');
	        	pic_tip.src = '/v/bxqp/img/fail_tip_4.png?v=1';
	        	time.innerHTML = '心急喝不了好啤酒，再等等哦<br />'+sessionStorage.batchName+'<br />服务热线：18519813990';
	            break;
	        case '5':              // 已截止
				mark.style.display = 'block';
				$('.slogan').css('display','none');
				time.innerHTML = '好酒不等人，下次来早点哦';
	        	pic_tip.src = '/v/bxqp/img/fail_tip_5.png?v=1';
	            break;
	        case '6':              // 指定
				mark.style.display = 'block';
				$('.slogan').css('display','none');
				time.innerHTML = '稍等片刻，畅享欢聚时刻';
	        	pic_tip.src = '/v/bxqp/img/fail_tip_6.png?v=1';
	            break;  
	        case '8':              // 需要验证码
				need_yzcode();
	            break;
